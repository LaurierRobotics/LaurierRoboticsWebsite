...
function z(t) {
    ...
    if (null === e.G) {
        ...
        t += Dn(e.startAt)), e.endAt && (t += "|ub:", t += Dn(e.endAt)), e.G = t;
    }
    return e.G;
}
...
function H(t, e) {
    ...
    var n, s;
    return t.collectionGroup === e.collectionGroup && (!!t.path.isEqual(e.path) && (!!Nn(t.startAt, e.startAt) && Nn(t.endAt, e.endAt)));
}
...
class At {
    ...
    isEqual(t) {
        if (!(this.fromCache === t.fromCache && this.Mt === t.Mt && this.qt.isEqual(t.qt) && En(this.query, t.query) && this.docs.isEqual(t.docs) && this.Ot.isEqual(t.Ot))) return !1;
 ...
 */ class Pt {
    ...
    static zt(t, e) {
        const n = new Map;
        return n.set(t, Vt.Kt(t, e)), new Pt(L.min(), n, Et(), ct(), Tt());
    }
}
...
class bt {
     ...
     */    Pe(t) {
        for (const e of t.Zt) t.te instanceof on ? this.Ve(e, t.te) : t.te instanceof hn && this.pe(e, t.key, t.te);
        ...
        this.Ee.forEach((n, s) => {
            ...
            if (i) {
                if (n.Ht && Y(i.target)) {
                    ...
                    null !== this.Ie.get(e) || this.$e(s, e) || this.pe(s, e, new hn(e, t));
                }
 ...
 */ (n, e) : t instanceof be ? Se(t, e) : t instanceof Ce ? De(t, e) : function(t, e) {
        ...
        const n = ge(t, e), s = Ne(n) + Ne(t.Me);
        return jt(n) && jt(t.Me) ? Zt(s) : te(t.serializer, s);
    }(t, e);
}
...
function Le(t, e) {
    return t.field.isEqual(e.field) && function(t, e) {
        return t instanceof be && e instanceof be || t instanceof Ce && e instanceof Ce ? v(t.elements, e.elements, kt) : t instanceof Fe && e instanceof Fe ? kt(t.Me, e.Me) : t instanceof ve && e instanceof ve;
 ...
 */ function Be(t, e, n) {
    return t instanceof ze ? function(t, e, n) {
        ...
        if (P(null != n.transformResults), !Me(t.Be, e)) 
        // Since the mutation was not rejected, we know that the  precondition
        // matched on the backend. We therefore must not have the expected version
        // of the document in our cache and return an UnknownDocument with the
        // known updateTime.
 ...
 */
        function(t, e, n) {
            ...
            for (let i = 0; i < n.length; i++) {
                ...
                let h = null;
                e instanceof on && (h = e.field(r.field)), s.push(ye(o, h, n[i]));
            }
            return s;
        }
        /**
...
function je(t, e) {
    return t.type === e.type && (!!t.key.isEqual(e.key) && (!!t.Be.isEqual(e.Be) && (0 /* Set */ === t.type ? t.value.isEqual(e.value) : 1 /* Patch */ === t.type ? t.data.isEqual(e.data) && t.qe.isEqual(e.qe) : 2 /* Transform */ !== t.type || v(t.fieldTransforms, t.fieldTransforms, (t, e) => Le(t, e)))));
}
 ...
 */ class nn {
    ...
    /** Returns an ObjectValue with all mutations applied. */    ze() {
        ...
        return null != t ? new en(t) : this.Ke;
    }
    /**
     ...
     */    Xe(t, e) {
        let n = !1;
        const s = this.Ke.field(t), i = Ht(s) ? // If there is already data at the current path, base our
 ...
 */ function fn(t) {
    ...
    if (null === e.nn) {
        ...
        t.O() || e.nn.push(new $n(t)), e.nn.push(new $n(U.q(), "asc" /* ASCENDING */)); else {
            let t = !1;
 ...
 */ function dn(t) {
    ...
    if (!e.sn) if ("F" /* First */ === e.en) e.sn = G(e.path, e.collectionGroup, fn(e), e.filters, e.limit, e.startAt, e.endAt); else {
        ...
        for (const n of fn(e)) {
            ...
            t.push(new $n(n.field, e));
        }
        // We need to swap the cursors to match the now-flipped query ordering.
                const n = e.endAt ? new Cn(e.endAt.position, !e.endAt.before) : null, s = e.startAt ? new Cn(e.startAt.position, !e.startAt.before) : null;
...
function In(t) {
    return `${z(dn(t))}|lt:${t.en}`;
}

function Rn(t) {
    return `Query(target=${K(dn(t))}; limitType=${t.en})`;
}
 ...
 */ (t, e) && function(t, e) {
    ...
    /** Makes sure a document is within the bounds, if provided. */ (t, e) && function(t, e) {
        if (t.startAt && !Fn(t.startAt, fn(t), e)) return !1;
        if (t.endAt && Fn(t.endAt, fn(t), e)) return !1;
        return !0;
    }
    /**
...
class Vn extends class {} {
     ...
     */    static create(t, e, n) {
        if (t.O()) return "in" /* IN */ === e ? new gn(t, n) : new yn(t, e, n);
        if (zt(n)) {
            if ("==" /* EQUAL */ !== e) throw new k($.INVALID_ARGUMENT, "Invalid query. Null supports only equality comparisons.");
            return new Vn(t, e, n);
        }
        if (Kt(n)) {
            if ("==" /* EQUAL */ !== e) throw new k($.INVALID_ARGUMENT, "Invalid query. NaN supports only equality comparisons.");
            return new Vn(t, e, n);
        }
        return "array-contains" /* ARRAY_CONTAINS */ === e ? new vn(t, n) : "in" /* IN */ === e ? new bn(t, n) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new Sn(t, n) : new Vn(t, e, n);
    }
    matches(t) {
        const e = t.field(this.field);
        // Only compare types with matching backend order (such as double and int).
                return null !== e && $t(this.value) === $t(e) && this.fn(Lt(e, this.value));
    }
    fn(t) {
        switch (this.op) {
          case "<" /* LESS_THAN */ :
...
/** Filter that matches on key fields within an array. */ class gn extends Vn {
    constructor(t, e) {
        super(t, "in" /* IN */ , e), this.keys = (e.arrayValue.values || []).map(t => B.U(t.referenceValue));
    }
    matches(t) {
...
/** A Filter that implements the array-contains operator. */ class vn extends Vn {
    constructor(t, e) {
...
/** A Filter that implements the IN operator. */ class bn extends Vn {
    constructor(t, e) {
        super(t, "in" /* IN */ , e);
    }
    matches(t) {
...
/** A Filter that implements the array-contains-any operator. */ class Sn extends Vn {
    constructor(t, e) {
...
class Ln {
     ...
     */    mn(t, e) {
        ...
        for (const n of this.baseMutations) n.key.isEqual(t) && (e = We(n, e, e, this.dn));
        const n = e;
        // Second, apply all user-provided mutations.
                for (const s of this.mutations) s.key.isEqual(t) && (e = We(s, e, n, this.dn));
        return e;
    }
    /**
...
/** The result of applying a mutation batch to the backend. */ class On {
    constructor(t, e, n, 
    /**
 ...
 */ class qn {
    ...
    next(t, e) {
        return this.pn && A(), this.pn = !0, this.Vn ? this.error ? this.yn(e, this.error) : this.gn(t, this.result) : new qn((n, s) => {
            this.An = e => {
    ...
    gn(t, e) {
        return t ? this.bn(() => t(e)) : qn.resolve(e);
    }
    yn(t, e) {
        return t ? this.bn(() => t(e)) : qn.reject(e);
    }
    static resolve(t) {
        return new qn((e, n) => {
            e(t);
 ...
 */
        return function(t) {
            return B.W(t.path) && null === t.collectionGroup && 0 === t.filters.length;
        }(e) ? this.Wn(t, e.path) : _n(e) ? this.Qn(t, e, n) : this.jn(t, e, n);
    }
    Wn(t, e) {
        // Just do a simple document lookup.
        return this.$n(t, new B(e)).next(t => {
            let e = ft();
    ...
    Qn(t, e, n) {
        ...
        let i = ft();
        return this.Nn.Gn(t, s).next(r => qn.forEach(r, r => {
    ...
    jn(t, e, n) {
        ...
        this.Kn(t, i, s).next(t => {
            ...
            for (const t of i) for (const e of t.mutations) {
                const n = e.key, i = s.get(n), r = We(e, i, i, t.dn);
 ...
 */ class Un {
 ...
 // do nothing
        ...
        return new Un(t, e.fromCache, n, s);
    }
}
 ...
 */ class Gn {
    ...
    add(t) {
        const e = t.S(), n = t.g(), s = this.index[e] || new ht(q.P), i = !s.has(n);
    ...
    getEntries(t) {
        return (this.index[t] || new ht(q.P)).F();
    }
}
 ...
 * limitations under the License.
 */
/** The Platform's 'window' implementation or null if not available. */ function Hn() {
...
class Yn {
    constructor(t, e, n, s, i) {
        this.Vs = t, this.rs = e, this.ps = n, this.op = s, this.ys = i, this.gs = new Wn, 
     ...
     */    cancel(t) {
        null !== this.bs && (this.clearTimeout(), this.gs.reject(new k($.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
    }
    Ss() {
...
class Xn {
    constructor() {
        ...
        this.Os = new Qn(this, "async_queue_retry" /* AsyncQueueRetry */), 
 ...
 */ (t)), t;
     ...
     */    ws(t, e, n) {
        ...
        const s = Yn.vs(this, t, e, n, t => this.Ks(t));
     ...
     */    Js(t) {
        ...
        return this.Ys().then(() => {
            ...
            for (const e of this.$s) if (e.ms(), "all" /* All */ !== t && e.rs === t) break;
            return this.Ys();
        });
    }
    /**
 ...
 */ function Jn(t, e) {
    if (E("AsyncQueue", `${e}: ${t}`), Kn(t)) return new k($.UNAVAILABLE, `${e}: ${t}`);
    throw t;
}
...
class Zn {
    ...
    static si(t) {
        return new Zn(t, Zn.ii, Zn.ri);
    }
}

Zn.oi = -1, Zn.hi = 1048576, Zn.ai = 41943040, Zn.ii = 10, Zn.ri = 1e3, Zn.ui = new Zn(Zn.ai, Zn.ii, Zn.ri), 
Zn.ci = new Zn(Zn.oi, 0, 0);
...
class ts {
    ...
    t, e, n) {
        ...
        this.fi = new N(t => z(t), H), 
        /**
         * The read time of the last entry processed by `getNewDocumentChanges()`.
         *
         * PORTING NOTE: This is only used for multi-tab synchronization.
         */
        this.di = L.min(), this.Fn = t.wi(n), this.Ti = t.mi(), this.Ei = t.Ii(), this.Ri = new Mn(this.Ti, this.Fn, this.persistence.Ai()), 
        this.li.Pi(this.Ri);
    }
    async Vi(t) {
        ...
        const s = await this.persistence.runTransaction("Handle user change", "readonly", s => {
            ...
            // MutationQueue.
            n = new Mn(this.Ti, e, this.persistence.Ai()), e.pi(s))).next(t => {
                const e = [], r = [];
    ...
    bi(t) {
        ...
        return this.persistence.runTransaction("Locally write mutations", "readwrite", i => this.Ri.qn(i, n).next(n => {
            ...
            for (const e of t) {
                ...
                // exists=true
                r.push(new Ke(e.key, t, sn(t.proto.mapValue), qe.exists(!0)));
            }
    ...
    Mi() {
        return this.persistence.runTransaction("Get last remote snapshot version", "readonly", t => this.Ei.Mi(t));
    }
    Ui(t) {
        const e = t.J;
        let n = this._i;
        return this.persistence.runTransaction("Apply remote event", "readwrite-primary", s => {
            ...
            t.Wt.forEach((t, i) => {
                ...
                // Update the resume token if the change includes one.
                    ...
                    ts.ji(o, a, t) && r.push(this.Ei.Gi(s, a));
                }
            });
            let o = ct(), h = Tt();
            ...
            r.push(i.getEntries(s, h).next(n => {
                ...
                const t = this.Ei.Mi(s).next(t => this.Ei.Xi(s, s.Qi, e));
                r.push(t);
            }
            return qn.Sn(r).next(() => i.apply(s)).next(() => this.Ri.Mn(s, o));
        }).then(t => (this._i = n, t));
    }
    /**
    ...
    async Zi(t) {
        try {
            await this.persistence.runTransaction("notifyLocalViewChanges", "readwrite", e => qn.forEach(t, t => qn.forEach(t.Hn, n => this.persistence.Yi.tr(e, t.targetId, n)).next(() => qn.forEach(t.Yn, n => this.persistence.Yi.er(e, t.targetId, n)))));
        } catch (t) {
            if (!Kn(t)) throw t;
    ...
    rr(t) {
        return this.persistence.runTransaction("Allocate target", "readwrite", e => {
            ...
            n = s, qn.resolve(n)) : this.Ei.hr(e).next(s => (n = new J(t, s, 0 /* Listen */ , e.Qi), 
    ...
    cr(t, e) {
        ...
        }).next(() => this.li.Bn(i, t, e ? n : L.min(), e ? s : Tt())).next(t => ({
            documents: t,
            _r: s
        })));
    }
...
class ns {
    constructor() {
        ...
        this.Tr = new ht(ss.mr), 
        // A set of outstanding references to a document sorted by target id.
        this.Er = new ht(ss.Ir);
    }
     ...
     * removed.
     */    Vr(t) {
        const e = new B(new q([])), n = new ss(e, t), s = new ss(e, t + 1), i = [];
    ...
    yr(t) {
        const e = new B(new q([])), n = new ss(e, t), s = new ss(e, t + 1);
        let i = Tt();
        return this.Er.bt([ n, s ], t => {
            i = i.add(t.key);
        }), i;
    ...
    gr(t) {
        const e = new ss(t, 0), n = this.Tr.Ct(e);
...
/** A user with a null UID. */ is.UNAUTHENTICATED = new is(null), 
// TODO(mikelehen): Look into getting a proper uid-equivalent for
// non-FirebaseAuth providers.
is.Cr = new is("google-credentials-uid"), is.Dr = new is("first-party-uid");
...
/** A CredentialsProvider that always yields an empty token. */ class os {
    constructor() {
        /**
...
class hs {
    constructor(t) {
        ...
        this.currentUser = is.UNAUTHENTICATED, this.Or = !1, 
        /**
    ...
    getToken() {
        ...
        this.getToken()) : e ? (P("string" == typeof e.accessToken), new rs(e.accessToken, this.currentUser)) : null) : Promise.resolve(null);
    }
    $r() {
        this.forceRefresh = !0;
    }
    ...
    Mr() {
        ...
        return P(null === t || "string" == typeof t), new is(t);
    }
}
 ...
 */ class as {
    constructor(t, e) {
        this.Ur = t, this.Br = e, this.type = "FirstParty", this.user = is.Dr;
    }
    get Fr() {
        const t = {
 ...
 */ class us {
    ...
    getToken() {
        return Promise.resolve(new as(this.Ur, this.Br));
    }
    kr(t) {
...
class cs {
    constructor(t, e, n, s, i, r) {
         ...
         * close.
         */
        this.zr = 0, this.Kr = null, this.stream = null, this.Os = new Qn(t, e);
    }
    /**
...
class ds {
    ...
    Fo(t) {
        ...
        this.So ? (E(e), this.So = !1) : m("OnlineStateTracker", e);
    }
    $o() {
...
class ws {
    ...
    e, n, s, i) {
        ...
        this.Go = function(t, e, n) {
            const s = V(t);
            return s.Ao(), new ls(e, s.jr, s.credentials, s.serializer, n);
        }
        /**
 * @license
 * Copyright 2018 Google LLC
 ...
 */ (this.xo, n, {
            ...
            const s = V(t);
            return s.Ao(), new _s(e, s.jr, s.credentials, s.serializer, n);
        }(this.xo, n, {
    ...
    nh() {
        this.qo = new bt(this), this.Go.start(), this.jo.Co();
    }
    /**
    ...
    async Ho(t, e) {
        ...
        this.jo.set("Online" /* Online */), t instanceof gt && 2 /* Removed */ === t.state && t.cause) 
        ...
        try {
            ...
            await this.fh(e);
        } else if (t instanceof pt ? this.qo.Pe(t) : t instanceof yt ? this.qo.Ce(t) : this.qo.ye(t), 
        !e.isEqual(L.min())) try {
    ...
    async mo(t, e) {
        const n = this.Lo.shift(), s = On.from(n, t, e);
 ...
 */ class ms {
    constructor() {
        this.Ch = new Ts, this.Dh = {}, this.yo = null, this.Jn = null;
    }
    Fh(t) {
        // No op.
    }
    ...
    start() {
        return this.Ch = new Ts, Promise.resolve();
    }
    Vi(t, e, n) {
        // No op.
    }
 ...
 */ class Rs {
    ...
    e) {
        ...
        this.qt = Tt(), this.jh = Pn(t), this.Gh = new It(this.jh);
    }
    /**
     ...
     */    Kh(t, e) {
        const n = e ? e.Hh : new Rt, s = e ? e.Gh : this.Gh;
 ...
 */ (t.type, e.type) || this.jh(t.doc, e.doc)), this.Zh(n);
        ...
        if (this.Wh = o, 0 !== i.length || h) {
            return {
                snapshot: new At(this.query, t.Gh, s, i, t.qt, 0 /* Local */ === o, h, 
                /* excludesMetadataChanges= */ !1),
                ea: r
            };
        }
    ...
    ta() {
        ...
        // updating many documents.
                const t = this.Qh;
        this.Qh = Tt(), this.Gh.forEach(t => {
            this.sa(t.key) && (this.Qh = this.Qh.add(t.key));
        });
        // Diff the new limbo docs with the old limbo docs.
        const e = [];
        return t.forEach(t => {
            this.Qh.has(t) || e.push(new Is(t));
        }), this.Qh.forEach(n => {
            t.has(n) || e.push(new Es(n));
        }), e;
    }
    /**
 ...
 */ class Vs {
    ...
    s, i, r) {
        ...
        this.ca = null, this.la = new N(t => In(t), En), this._a = new Map, 
        /**
         ...
         */
        this.wa = new Map, this.Ta = new ns, 
    ...
    async listen(t) {
        ...
        e = s.targetId, this.aa.$h(e), n = s.view.ra(); else {
            const s = await this.ko.rr(dn(t)), i = this.aa.$h(s.targetId);
     ...
     */    async Va(t, e, n) {
        ...
        /* usePreviousResults= */ !0), i = new Rs(t, s._r), r = i.Kh(s.documents), o = Vt.Kt(e, n && "Offline" /* Offline */ !== this.onlineState), h = i.Jh(r, 
        /* updateLimboDocuments= */ this.Aa, o);
        this.pa(e, h.ea);
        const a = new As(t, e, i);
    ...
    async ah(t) {
        ...
        // to the target.
                if (n.length > 1) return this._a.set(e.targetId, n.filter(e => !En(e, t))), 
    ...
    async Th(t, e) {
        ...
        } else await this.ko.ur(t, /* keepPersistedTargetData */ !1).then(() => this.ya(t, e)).catch(es);
    }
    async Ph(t) {
    ...
    async Fa(t) {
        ...
        try {
            ...
            const n = this.Ea.get(e) || [];
            n.push(t), this.Ea.set(e, n);
        } catch (e) {
    ...
    ga(t, e) {
        let n = this.ma[this.currentUser.Sr()];
        n || (n = new it(g)), n = n.nt(t, e), this.ma[this.currentUser.Sr()] = n;
    }
    /**
     ...
     */    Ca(t, e) {
        ...
        // okay for there to be no callback for this ID.
                if (n) {
            const s = n.get(t);
            s && (e ? s.reject(e) : s.resolve(), n = n.remove(t)), this.ma[this.currentUser.Sr()] = n;
        }
    }
    ya(t, e = null) {
        this.aa.xh(t);
    ...
    pa(t, e) {
        for (const n of e) if (n instanceof Es) this.Ta.tr(n.key, t), this.xa(n); else if (n instanceof Is) {
     ...
     */    Sa() {
        for (;this.fa.length > 0 && this.da.size < this.ua; ) {
            ...
            this.wa.set(e, new Ps(t)), this.da = this.da.nt(t, e), this.ha.listen(new J(dn(ln(t.path)), e, 2 /* LimboResolution */ , Bn.ns));
        }
    }
    // Visible for testing
    La() {
        ...
        this.la.forEach((r, o) => {
            i.push(Promise.resolve().then(() => {
                ...
                if (this.pa(o.targetId, r.ea), r.snapshot) {
                    ...
                    n.push(r.snapshot);
                    const t = Un.Xn(o.targetId, r.snapshot);
                    s.push(t);
                }
            }));
 ...
 */ class ys {
    constructor(t) {
        this.lh = t, this.Ma = new N(t => In(t), En), this.onlineState = "Unknown" /* Unknown */ , 
        this.Ua = new Set, this.lh.subscribe(this);
    }
    async listen(t) {
        const e = t.query;
        let n = !1, s = this.Ma.get(e);
        if (s || (n = !0, s = new ps), n) try {
 ...
 */ class vs {
    ...
    Bn(t, e, s, i) {
        ...
        return e.on() || s.isEqual(L.min()) ? this.tu(t, e) : this.Za.qn(t, i).next(r => {
            const o = this.eu(e, r);
            return (e.hn() || e.an()) && this.Xh(e.en, o, i, s) ? this.tu(t, e) : (T() <= n.DEBUG && m("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", s.toString(), Rn(e)), 
 ...
 */ class bs {
    ...
    Si(t, e, n, s) {
        ...
        const r = new Ln(i, e, n, s);
        this.Fn.push(r);
        // Track references by document key and index collection parents.
        for (const e of s) this.su = this.su.add(new ss(e.key, i)), this.Nn.Is(t, e.key.path.g());
        return qn.resolve(r);
    }
    Li(t, e) {
    ...
    kn(t, e) {
        const n = new ss(e, 0), s = new ss(e, Number.POSITIVE_INFINITY), i = [];
    ...
    Un(t, e) {
        let n = new ht(g);
        return e.forEach(t => {
            const e = new ss(t, 0), s = new ss(t, Number.POSITIVE_INFINITY);
            this.su.bt([ e, s ], t => {
                n = n.add(t.vr);
            });
    ...
    Oi(t, e) {
        ...
        return qn.forEach(e.mutations, s => {
            const i = new ss(s.key, e.batchId);
    ...
    gr(t, e) {
        const n = new ss(e, 0), s = this.su.Ct(n);
...
class Cs {
    constructor(t) {
         ...
         * IDs.
         */
        this.pu = new ns, this.targetCount = 0, this.yu = zn.As();
    }
    ge(t, e) {
...
class Ds {
     ...
     */
    constructor(t) {
        this.Fu = {}, this.Nu = new Bn(0), this.$u = !1, this.$u = !0, this.Yi = t(this), 
        this.Ei = new Cs(this);
        this.Nn = new jn, this.Dn = new Ss(this.Nn, t => this.Yi.ku(t));
    }
    start() {
    ...
    wi(t) {
        let e = this.Fu[t.Sr()];
        return e || (e = new bs(this.Nn, this.Yi), this.Fu[t.Sr()] = e), e;
    }
    Ii() {
        return this.Ei;
    }
    ...
    runTransaction(t, e, n) {
        ...
        const s = new Fs(this.Nu.next());
        return this.Yi.qu(), n(s).next(t => this.Yi.Mu(s).next(() => t)).vn().then(t => (s.Uu(), 
        t));
    }
    Bu(t, e) {
        return qn.Cn(Object.values(this.Fu).map(n => () => n.gr(t, e)));
    }
}
...
class Ns {
    ...
    Mu(t) {
        ...
        return qn.forEach(this.Ku, n => this.Hu(t, n).next(t => {
            t || e.zi(n);
    ...
    Hu(t, e) {
        return qn.Cn([ () => qn.resolve(this.ju.gr(e)), () => this.persistence.Ii().gr(t, e), () => this.persistence.Bu(t, e) ]);
    }
}
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const Ms = "You are using the memory-only build of Firestore. Persistence support is only available via the @firebase/firestore bundle or the firebase-firestore.js build.";
 ...
 */ class Us {
    async initialize(t) {
        this.aa = this.mc(t), this.persistence = this.Ec(t), await this.persistence.start(), 
    ...
    Ac(t) {
        /** Manages our in-memory or durable persistence. */
        return e = this.persistence, n = new vs, s = t.Pc, new ts(e, n, s);
        var e, n, s;
    }
    Ec(t) {
        if (t.pc.Vc) throw new k($.FAILED_PRECONDITION, Ms);
        return new Ds(Ns.zu);
    }
    mc(t) {
        return new ms;
    ...
    clearPersistence(t, e) {
        throw new k($.FAILED_PRECONDITION, Ms);
    }
}
 ...
 */ class Bs {
    ...
    gc(t) {
        return e = t.ic, Promise.resolve(new xs(e));
        var e;
        /** Return the Platform-specific connectivity monitor. */    }
    Cc(t) {
        return new ys(this.lh);
    }
    yc(t) {
        const e = qs(t.ic.s);
        return function(t, e) {
    ...
    vc(t) {
        return new ws(this.ko, this.xo, t.Vs, t => this.lh.na(t, 0 /* RemoteStore */), Ls.Tc() ? new Ls : new Os);
    }
    bc(t) {
        return function(t, e, n, 
        // PORTING NOTE: Manages state synchronization in multi-tab environments.
        s, i, r, o) {
            const h = new Vs(t, e, n, s, i, r);
            return o && (h.Ra = !0), h;
 ...
 */ function js(t, e) {
    if (0 !== e.length) throw new k($.INVALID_ARGUMENT, `Function ${t}() does not support arguments, but was called with ` + ci(e.length, "argument") + ".");
}
 ...
 */ function Gs(t, e, n) {
    if (e.length !== n) throw new k($.INVALID_ARGUMENT, `Function ${t}() requires ` + ci(n, "argument") + ", but was called with " + ci(e.length, "argument") + ".");
}
 ...
 */ function zs(t, e, n) {
    if (e.length < n) throw new k($.INVALID_ARGUMENT, `Function ${t}() requires at least ` + ci(n, "argument") + ", but was called with " + ci(e.length, "argument") + ".");
}
 ...
 */ function Ks(t, e, n, s) {
    if (e.length < n || e.length > s) throw new k($.INVALID_ARGUMENT, `Function ${t}() requires between ${n} and ` + s + " arguments, but was called with " + ci(e.length, "argument") + ".");
}
...
function Zs(t, e, n, s, i) {
    void 0 !== s && function(t, e, n, s, i) {
        if (!(s instanceof Array)) throw new k($.INVALID_ARGUMENT, `Function ${t}() requires its ${e} option to be an array, but it was: ` + ii(s));
        for (let r = 0; r < s.length; ++r) if (!i(s[r])) throw new k($.INVALID_ARGUMENT, `Function ${t}() requires all ${e} elements to be ${n}, but the value at index ${r} was: ` + ii(s[r]));
    }(t, e, n, s, i);
}
 ...
 */ function ei(t, e, n, s) {
    if (!e.some(t => t === s)) throw new k($.INVALID_ARGUMENT, `Invalid value ${ii(s)} provided to function ${t}() for its ${ui(n)} argument. Acceptable values: ` + e.join(", "));
    return s;
}

/** Helper to validate the type of a provided input. */ function ni(t, e, n, s) {
    let i = !1;
    if (i = "object" === e ? si(s) : "non-empty string" === e ? "string" == typeof s && "" !== s : typeof s === e, 
    !i) {
        const i = ii(s);
...
/** Returns a string describing the type / value of the provided input. */ function ii(t) {
...
function ri(t, e, n) {
    if (void 0 === n) throw new k($.INVALID_ARGUMENT, `Function ${t}() requires a valid ${ui(e)} argument, but it was undefined.`);
}
 ...
 */ function hi(t, e, n, s) {
    const i = ii(s);
    return new k($.INVALID_ARGUMENT, `Function ${t}() requires its ${ui(n)} argument to be a ${e}, but it was: ${i}`);
}

function ai(t, e, n) {
    if (n <= 0) throw new k($.INVALID_ARGUMENT, `Function ${t}() requires its ${ui(e)} argument to be a positive number, but it was: ${n}.`);
}
 ...
 * limitations under the License.
 */
/** Helper function to assert Uint8Array is available at runtime. */ function li() {
    if ("undefined" == typeof Uint8Array) throw new k($.UNIMPLEMENTED, "Uint8Arrays are not available in this environment.");
}

/** Helper function to assert Base64 functions are available at runtime. */ function _i() {
 ...
 */ class fi {
    ...
    static fromBase64String(t) {
        Gs("Blob.fromBase64String", arguments, 1), Hs("Blob.fromBase64String", "string", 1, t), 
        _i();
        try {
            return new fi(X.fromBase64String(t));
        } catch (t) {
            throw new k($.INVALID_ARGUMENT, "Failed to construct Blob from Base64 string: " + t);
        }
    }
    static fromUint8Array(t) {
        if (Gs("Blob.fromUint8Array", arguments, 1), li(), !(t instanceof Uint8Array)) throw hi("Blob.fromUint8Array", "Uint8Array", 1, t);
        return new fi(X.fromUint8Array(t));
    }
    toBase64() {
        return Gs("Blob.toBase64", arguments, 0), _i(), this.Nc.toBase64();
    }
    toUint8Array() {
        return Gs("Blob.toUint8Array", arguments, 0), li(), this.Nc.toUint8Array();
    }
    toString() {
 ...
 */ class di {
    constructor(t) {
        !function(t, e, n, s) {
            if (!(e instanceof Array) || e.length < s) throw new k($.INVALID_ARGUMENT, `Function ${t}() requires its ${n} argument to be an array with at least ` + ci(s, "element") + ".");
        }("FieldPath", t, "fieldNames", 1);
        for (let e = 0; e < t.length; ++e) if (Hs("FieldPath", "string", e, t[e]), 0 === t[e].length) throw new k($.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
        this.$c = new U(t);
    }
}
 ...
 */ class wi extends di {
    ...
    isEqual(t) {
        if (!(t instanceof wi)) throw hi("isEqual", "FieldPath", 1, t);
...
class Ai extends mi {
    ...
    Lc(t) {
        const e = Ii(this, t, 
        /*array=*/ !0), n = this.Bc.map(t => Oi(t, e)), s = new be(n);
...
class Pi extends mi {
    ...
    Lc(t) {
        const e = Ii(this, t, 
        /*array=*/ !0), n = this.Bc.map(t => Oi(t, e)), s = new Ce(n);
        return new xe(t.path, s);
    }
    isEqual(t) {
        // TODO(mrschmidt): Implement isEquals
...
class Vi extends mi {
    ...
    Lc(t) {
        const e = new Fe(t.serializer, ee(t.serializer, this.Wc));
...
/** The public FieldValue class of the lite API. */ class pi extends mi {
    constructor() {
        super();
    }
    static delete() {
        return js("FieldValue.delete", arguments), new yi(new Ei("FieldValue.delete"));
    }
    static serverTimestamp() {
        return js("FieldValue.serverTimestamp", arguments), new yi(new Ri("FieldValue.serverTimestamp"));
    }
    static arrayUnion(...t) {
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we'd need the Firestore instance to do this.
        return zs("FieldValue.arrayUnion", arguments, 1), new yi(new Ai("FieldValue.arrayUnion", t));
    }
    static arrayRemove(...t) {
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we'd need the Firestore instance to do this.
        return zs("FieldValue.arrayRemove", arguments, 1), new yi(new Pi("FieldValue.arrayRemove", t));
    }
    static increment(t) {
        return Hs("FieldValue.increment", "number", 1, t), Gs("FieldValue.increment", arguments, 1), 
        new yi(new Vi("FieldValue.increment", t));
    }
}
 ...
 */ class yi extends pi {
    ...
    isEqual(t) {
        return t instanceof yi && this.kc.isEqual(t.kc);
    }
}
 ...
 */ class gi {
    constructor(t, e) {
        if (Gs("GeoPoint", arguments, 2), Hs("GeoPoint", "number", 1, t), Hs("GeoPoint", "number", 2, e), 
     ...
     * with an underscore.
     */    T(t) {
        return g(this.Qc, t.Qc) || g(this.jc, t.jc);
    }
}
...
/** The result of parsing document data (e.g. for a setData call). */ class Si {
    constructor(t, e, n) {
        this.data = t, this.qe = e, this.fieldTransforms = n;
    }
    Hc(t, e) {
        const n = [];
        return null !== this.qe ? n.push(new Ke(t, this.data, this.qe, e)) : n.push(new ze(t, this.data, e)), 
        this.fieldTransforms.length > 0 && n.push(new Ye(t, this.fieldTransforms)), n;
    }
}

/** The result of parsing "update" data (i.e. for an updateData call). */ class Ci {
    constructor(t, e, n) {
        this.data = t, this.qe = e, this.fieldTransforms = n;
    }
    Hc(t, e) {
        const n = [ new Ke(t, this.data, this.qe, e) ];
...
/** A "context" object passed around while parsing user data. */ class Fi {
    /**
    ...
    /** Returns a new context with the specified settings overwritten. */    Xc(t) {
        return new Fi(Object.assign(Object.assign({}, this.settings), t), this.s, this.serializer, this.ignoreUndefinedProperties, this.fieldTransforms, this.qe);
    }
    Jc(t) {
        var e;
    ...
    qc(t) {
        return Qi(t, this.settings.methodName, this.settings.nl || !1, this.path, this.settings.Mc);
    }
    ...
    Zc(t) {
        ...
        if (Di(this.Oc) && vi.test(t)) throw this.qc('Document fields cannot begin and end with "__"');
    }
}
...
/** Parse document data from a set() call. */ function $i(t, e, n, s, i, r = {}) {
    const o = t.sl(r.merge || r.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , e, n, i);
    Ui("Data must be an object, but it was:", o, s);
    const h = qi(s, o);
    let a, u;
    if (r.merge) a = new ke(o.qe), u = o.fieldTransforms; else if (r.mergeFields) {
        const t = [];
        for (const s of r.mergeFields) {
            let i;
            if (s instanceof di) i = s.$c; else {
    ...
    return new Si(new en(h), a, u);
}

/** Parse update data from an update() call. */ function ki(t, e, n, s) {
    const i = t.sl(1 /* Update */ , e, n);
    Ui("Data must be an object, but it was:", i, s);
    const r = [], o = new nn;
    D(s, (t, s) => {
        const h = Wi(e, t, n), a = i.tl(h);
        if (s instanceof mi && s.kc instanceof Ei) 
    ...
    const h = new ke(r);
    return new Ci(o.ze(), h, i.fieldTransforms);
}

/** Parse update data from a list of field/value arguments. */ function xi(t, e, n, s, i, r) {
    const o = t.sl(1 /* Update */ , e, n), h = [ Bi(e, s, n) ], a = [ i ];
    ...
    for (let t = 0; t < r.length; t += 2) h.push(Bi(e, r[t])), a.push(r[t + 1]);
    const u = [], c = new nn;
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (let t = h.length - 1; t >= 0; --t) if (!ji(u, h[t])) {
        const e = h[t], n = a[t], s = o.tl(e);
        if (n instanceof mi && n.kc instanceof Ei) 
        // Add it to the field mask, but don't add anything to updateData.
        u.push(e); else {
            const t = Oi(n, s);
    ...
    const l = new ke(u);
    return new Ci(c.ze(), l, o.fieldTransforms);
}
 ...
 */ function Li(t, e, n, s = !1) {
    return Oi(n, t.sl(s ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function Oi(t, e) {
    if (Mi(t)) return Ui("Unsupported field value:", e, t), qi(t, e);
    if (t instanceof mi) 
 ...
 */ (t, e), null;
    ...
    return function(t, e) {
        ...
        if (t instanceof bi) {
            ...
            return {
                referenceValue: oe(t.Gc || e.s, t.zc.path)
            };
        }
        if (void 0 === t && e.ignoreUndefinedProperties) return null;
        throw e.qc("Unsupported field value: " + ii(t));
    }
    /**
...
function Mi(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof x || t instanceof gi || t instanceof fi || t instanceof bi || t instanceof mi);
}
 ...
 */ function Bi(t, e, n) {
    if (e instanceof di) return e.$c;
    if ("string" == typeof e) return Wi(t, e);
    throw Qi("Field path arguments must be of type string or FieldPath.", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
}
 ...
 */ function Wi(t, e, n) {
    try {
        return function(t) {
            if (t.search(Ti) >= 0) throw new k($.INVALID_ARGUMENT, `Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`);
            try {
                return new wi(...t.split("."));
            } catch (e) {
                throw new k($.INVALID_ARGUMENT, `Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`);
            }
        }(e).$c;
    } catch (e) {
        throw Qi((s = e) instanceof Error ? s.message : s.toString(), t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, n);
    }
    /**
 ...
 */ class Gi {
    ...
    async al(t) {
        if (this.ul(), this.mutations.length > 0) throw new k($.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
        ...
        return e.forEach(t => {
            t instanceof hn || t instanceof on ? this.cl(t) : A();
        }), e;
    }
    set(t, e) {
    ...
    delete(t) {
        this.write([ new Ze(t, this.Be(t)) ]), this.hl.add(t);
    }
    async commit() {
...
class zi {
    constructor(t, e, n, s) {
        this.Vs = t, this.xo = e, this.updateFunction = n, this.gs = s, this._l = 5, this.Os = new Qn(this.Vs, "transaction_retry" /* TransactionRetry */);
    }
    ...
    fl() {
        this.Os.fs(async () => {
            const t = new Gi(this.xo), e = this.dl(t);
            e && e.then(e => {
    ...
    dl(t) {
        try {
            ...
            return !W(e) && e.catch && e.then ? e : (this.gs.reject(Error("Transaction callback must return a Promise")), 
            null);
        } catch (t) {
...
class Ki {
     ...
     */
    e) {
        this.credentials = t, this.Vs = e, this.clientId = y.t(), 
     ...
     */    start(t, e, n, s) {
        ...
        this.Vs.Cs(() => this.ml.promise), i.promise;
    }
    /** Enables the network connection and requeues all pending operations. */    enableNetwork() {
        return this.El(), this.Vs.enqueue(() => (this.persistence.Ou(!0), this.ha.enableNetwork()));
    }
    /**
     ...
     */    El() {
        if (this.Vs.Ms) throw new k($.FAILED_PRECONDITION, "The client has already been terminated.");
    }
    /** Disables the network connection. Pending operations will not complete. */    disableNetwork() {
        return this.El(), this.Vs.enqueue(() => (this.persistence.Ou(!1), this.ha.disableNetwork()));
    }
    terminate() {
    ...
    listen(t, e, n) {
        this.El();
        const s = new Qs(n), i = new gs(t, s, e);
 ...
 */ (this.Vs, this.ko, t);
    ...
    async Vl(t, e) {
        return this.El(), await this.ml.promise, function(t, e, n, s) {
            const i = new Wn, r = Hi(t, e, ln(n.path), {
        ...
        return this.El(), await this.ml.promise, async function(t, e, n) {
            ...
            return await t.enqueue(async () => {
                try {
                    ...
                    /* usePreviousResults= */ !0), i = new Rs(n, t._r), r = i.Kh(t.documents), o = i.Jh(r, 
                    /* updateLimboDocuments= */ !1);
 ...
 */ (this.Vs, this.Rl, t, e);
     ...
     */    transaction(t) {
        this.El();
        const e = new Wn;
        return this.Vs.Cs(() => (new zi(this.Vs, this.xo, t, e).run(), Promise.resolve())), 
        e.promise;
    }
}

function Hi(t, e, n, s, i) {
    const r = new Qs(i), o = new gs(n, r, s);
...
class Yi {
    ...
    Nl(t) {
        return new gi(Bt(t.latitude), Bt(t.longitude));
    }
    $l(t) {
...
class Ji {
    constructor(t) {
        ...
        } else Xs("settings", "non-empty string", "host", t.host), this.host = t.host, Js("settings", "boolean", "ssl", t.ssl), 
        ...
        Js("settings", "object", "credentials", t.credentials), this.credentials = t.credentials, 
        Js("settings", "boolean", "timestampsInSnapshots", t.timestampsInSnapshots), Js("settings", "boolean", "ignoreUndefinedProperties", t.ignoreUndefinedProperties), 
        ...
        Js("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = Zn.ai; else {
            if (t.cacheSizeBytes !== Xi && t.cacheSizeBytes < Zn.hi) throw new k($.INVALID_ARGUMENT, "cacheSizeBytes must be at least " + Zn.hi);
            this.cacheSizeBytes = t.cacheSizeBytes;
        }
        Js("settings", "boolean", "experimentalForceLongPolling", t.experimentalForceLongPolling), 
 ...
 */ class Zi {
    ...
    constructor(t, e, n = new Us, s = new Bs) {
        if (this.xl = n, this.Ll = s, this.Ol = null, 
        // Public for use in tests.
        // TODO(mikelehen): Use modularized initialization instead.
        this.ql = new Xn, this.INTERNAL = {
            delete: async () => {
            ...
            const n = t;
            this.Ol = n, this.Gc = Zi.Bl(n), this.Wl = n.name, this.Ql = new hs(e);
        } else {
            const e = t;
            if (!e.projectId) throw new k($.INVALID_ARGUMENT, "Must provide projectId");
            this.Gc = new S(e.projectId, e.database), 
            // Use a default persistenceKey that lines up with FirebaseApp.
            this.Wl = "[DEFAULT]", this.Ql = new os;
        }
        this.jl = new Ji({});
    }
    get Gl() {
        ...
        this.zl = new Ni(this.Gc, this.jl.ignoreUndefinedProperties)), this.zl;
    }
    settings(t) {
        Gs("Firestore.settings", arguments, 1), Hs("Firestore.settings", "object", 1, t);
        const e = new Ji(t);
 ...
 */ (e.credentials));
    ...
    onSnapshotsInSync(t) {
        if (this.Ml(), Ws(t)) return this.Ul.Qa(t);
        {
            Hs("Firestore.onSnapshotsInSync", "function", 1, t);
            const e = {
                next: t
            };
            return this.Ul.Qa(e);
    ...
    Hl(t, e, n) {
        const s = this.Jl();
        return this.Ul = new Ki(this.Ql, this.ql), this.Ul.start(s, t, e, n);
    }
    static Bl(t) {
 ...
 */        const s = t.options.projectId;
    ...
    collection(t) {
        return Gs("Firestore.collection", arguments, 1), Hs("Firestore.collection", "non-empty string", 1, t), 
        this.Ml(), new dr(q.$(t), this, 
        /* converter= */ null);
    }
    doc(t) {
        return Gs("Firestore.doc", arguments, 1), Hs("Firestore.doc", "non-empty string", 1, t), 
        this.Ml(), nr.Zl(q.$(t), this, 
        /* converter= */ null);
    }
    collectionGroup(t) {
        if (Gs("Firestore.collectionGroup", arguments, 1), Hs("Firestore.collectionGroup", "non-empty string", 1, t), 
        ...
        return this.Ml(), new _r(function(t) {
            return new cn(q.k(), t);
        }(t), this, 
        /* converter= */ null);
    }
    runTransaction(t) {
        return Gs("Firestore.runTransaction", arguments, 1), Hs("Firestore.runTransaction", "function", 1, t), 
        this.Ml().transaction(e => t(new tr(this, e)));
    }
    batch() {
        return this.Ml(), new er(this);
    }
    static get logLevel() {
        switch (T()) {
          case n.DEBUG:
    ...
    static setLogLevel(t) {
        var e;
        Gs("Firestore.setLogLevel", arguments, 1), ei("setLogLevel", [ "debug", "error", "silent", "warn", "info", "verbose" ], 1, t), 
        e = t, w.setLogLevel(e);
    }
 ...
 */ class tr {
    ...
    get(t) {
        Gs("Transaction.get", arguments, 1);
        const e = Er("Transaction.get", t, this.e_);
        return this.n_.al([ e.zc ]).then(t => {
            if (!t || 1 !== t.length) return A();
            const n = t[0];
            if (n instanceof hn) return new ir(this.e_, e.zc, null, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, e.Kc);
            if (n instanceof on) return new ir(this.e_, e.zc, n, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, e.Kc);
            throw A();
        });
    ...
    set(t, e, n) {
        Ks("Transaction.set", arguments, 2, 3);
        const s = Er("Transaction.set", t, this.e_);
        n = wr("Transaction.set", n);
        const i = Rr(s.Kc, e, n), r = $i(this.e_.Gl, "Transaction.set", s.zc, i, null !== s.Kc, n);
        return this.n_.set(s.zc, r), this;
    }
    update(t, e, n, ...s) {
        let i, r;
        return "string" == typeof e || e instanceof wi ? (zs("Transaction.update", arguments, 3), 
        i = Er("Transaction.update", t, this.e_), r = xi(this.e_.Gl, "Transaction.update", i.zc, e, n, s)) : (Gs("Transaction.update", arguments, 2), 
        i = Er("Transaction.update", t, this.e_), r = ki(this.e_.Gl, "Transaction.update", i.zc, e)), 
        this.n_.update(i.zc, r), this;
    }
    delete(t) {
        Gs("Transaction.delete", arguments, 1);
        const e = Er("Transaction.delete", t, this.e_);
...
class er {
    ...
    set(t, e, n) {
        Ks("WriteBatch.set", arguments, 2, 3), this.r_();
        const s = Er("WriteBatch.set", t, this.e_);
        n = wr("WriteBatch.set", n);
        const i = Rr(s.Kc, e, n), r = $i(this.e_.Gl, "WriteBatch.set", s.zc, i, null !== s.Kc, n);
        return this.s_ = this.s_.concat(r.Hc(s.zc, qe.je())), this;
    }
    update(t, e, n, ...s) {
        let i, r;
        return this.r_(), "string" == typeof e || e instanceof wi ? (zs("WriteBatch.update", arguments, 3), 
        i = Er("WriteBatch.update", t, this.e_), r = xi(this.e_.Gl, "WriteBatch.update", i.zc, e, n, s)) : (Gs("WriteBatch.update", arguments, 2), 
        i = Er("WriteBatch.update", t, this.e_), r = ki(this.e_.Gl, "WriteBatch.update", i.zc, e)), 
        this.s_ = this.s_.concat(r.Hc(i.zc, qe.exists(!0))), this;
    }
    delete(t) {
        Gs("WriteBatch.delete", arguments, 1), this.r_();
        const e = Er("WriteBatch.delete", t, this.e_);
        return this.s_ = this.s_.concat(new Ze(e.zc, qe.je())), this;
    }
    commit() {
 ...
 */ class nr extends bi {
    ...
    static Zl(t, e, n) {
        ...
        return new nr(new B(t), e, n);
    }
    get id() {
        return this.zc.path.S();
    }
    get parent() {
        return new dr(this.zc.path.g(), this.firestore, this.Kc);
    }
    get path() {
        return this.zc.path.N();
    }
    collection(t) {
        if (Gs("DocumentReference.collection", arguments, 1), Hs("DocumentReference.collection", "non-empty string", 1, t), 
        !t) throw new k($.INVALID_ARGUMENT, "Must provide a non-empty collection name to collection()");
        const e = q.$(t);
        return new dr(this.zc.path.child(e), this.firestore, 
        /* converter= */ null);
    }
    isEqual(t) {
        if (!(t instanceof nr)) throw hi("isEqual", "DocumentReference", 1, t);
        return this.firestore === t.firestore && this.zc.isEqual(t.zc) && this.Kc === t.Kc;
    }
    set(t, e) {
        Ks("DocumentReference.set", arguments, 1, 2), e = wr("DocumentReference.set", e);
        const n = Rr(this.Kc, t, e), s = $i(this.firestore.Gl, "DocumentReference.set", this.zc, n, null !== this.Kc, e);
        return this.Ul.write(s.Hc(this.zc, qe.je()));
    }
    update(t, e, ...n) {
        let s;
        return "string" == typeof t || t instanceof wi ? (zs("DocumentReference.update", arguments, 2), 
        s = xi(this.firestore.Gl, "DocumentReference.update", this.zc, t, e, n)) : (Gs("DocumentReference.update", arguments, 1), 
        s = ki(this.firestore.Gl, "DocumentReference.update", this.zc, t)), this.Ul.write(s.Hc(this.zc, qe.exists(!0)));
    }
    delete() {
        return Gs("DocumentReference.delete", arguments, 0), this.Ul.write([ new Ze(this.zc, qe.je()) ]);
    }
    onSnapshot(...t) {
        var e, n, s;
        Ks("DocumentReference.onSnapshot", arguments, 1, 4);
        let i = {
            includeMetadataChanges: !1
        }, r = 0;
        "object" != typeof t[r] || Ws(t[r]) || (i = t[r], oi("DocumentReference.onSnapshot", i, [ "includeMetadataChanges" ]), 
        Js("DocumentReference.onSnapshot", "boolean", "includeMetadataChanges", i.includeMetadataChanges), 
        r++);
        const o = {
        ...
        } else Hs("DocumentReference.onSnapshot", "function", r, t[r]), Ys("DocumentReference.onSnapshot", "function", r + 1, t[r + 1]), 
        Ys("DocumentReference.onSnapshot", "function", r + 2, t[r + 2]);
        const h = {
            next: e => {
                t[r] && t[r](this.o_(e));
            },
        ...
        return this.Ul.listen(ln(this.zc.path), o, h);
    }
    get(t) {
        Ks("DocumentReference.get", arguments, 0, 1), mr("DocumentReference.get", t);
        const e = this.firestore.Ml();
        return t && "cache" === t.source ? e.Pl(this.zc).then(t => new ir(this.firestore, this.zc, t, 
        /*fromCache=*/ !0, t instanceof on && t.Ge, this.Kc)) : e.Vl(this.zc, t).then(t => this.o_(t));
    }
    withConverter(t) {
        return new nr(this.zc, this.firestore, t);
    }
    /**
     ...
     */    o_(t) {
        ...
        return new ir(this.firestore, this.zc, e, t.fromCache, t.hasPendingWrites, this.Kc);
    }
}
...
class ir {
    ...
    data(t) {
        if (Ks("DocumentSnapshot.data", arguments, 0, 1), t = Tr("DocumentSnapshot.data", t), 
        this.h_) {
            // We only want to use the converter and create a new DocumentSnapshot
            // if a converter has been provided.
            if (this.Kc) {
                const e = new rr(this.e_, this.zc, this.h_, this.a_, this.u_, 
                /* converter= */ null);
                return this.Kc.fromFirestore(e, t);
            }
            return new Yi(this.e_.Gc, this.e_.t_(), t.serverTimestamps || "none", t => new nr(t, this.e_, /* converter= */ null)).Sl(this.h_.Ze());
        }
    }
    get(t, e) {
        if (Ks("DocumentSnapshot.get", arguments, 1, 2), e = Tr("DocumentSnapshot.get", e), 
        this.h_) {
            const n = this.h_.data().field(Bi("DocumentSnapshot.get", t, this.zc));
            if (null !== n) {
                return new Yi(this.e_.Gc, this.e_.t_(), e.serverTimestamps || "none", t => new nr(t, this.e_, this.Kc)).Sl(n);
            }
        }
    }
    get id() {
    ...
    get ref() {
        return new nr(this.zc, this.e_, this.Kc);
    }
    get exists() {
        return null !== this.h_;
    }
    get metadata() {
        return new sr(this.u_, this.a_);
    }
    isEqual(t) {
        if (!(t instanceof ir)) throw hi("isEqual", "DocumentSnapshot", 1, t);
...
function or(t, e, n, s, i, r, o) {
    ...
    if (i.O()) {
        ...
        if ("in" /* IN */ === r) {
            ur(o, r);
            const e = [];
            for (const n of o) e.push(ar(s, t, n));
            h = {
                arrayValue: {
                    values: e
                }
    ...
    } else "in" /* IN */ !== r && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== r || ur(o, r), 
    h = Li(n, e, o, "in" /* IN */ === r);
    ...
    return function(t, e) {
        ...
        if (e.ln()) {
            ...
            throw o === e.op ? new k($.INVALID_ARGUMENT, `Invalid query. You cannot use more than one '${e.op.toString()}' filter.`) : new k($.INVALID_ARGUMENT, `Invalid query. You cannot use '${e.op.toString()}' filters with '${o.toString()}' filters.`);
        }
    }(t, a), a;
}
...
function ar(t, e, n) {
    ...
    if (n instanceof bi) return Qt(t, n.zc);
    throw new k($.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + ii(n) + ".");
}
...
class _r {
    ...
    where(t, e, n) {
        Gs("Query.where", arguments, 3), ri("Query.where", 3, n);
        // Enumerated from the WhereFilterOp type in index.d.ts.
        const s = ei("Query.where", [ "<" /* LESS_THAN */ , "<=" /* LESS_THAN_OR_EQUAL */ , "==" /* EQUAL */ , ">=" /* GREATER_THAN_OR_EQUAL */ , ">" /* GREATER_THAN */ , "array-contains" /* ARRAY_CONTAINS */ , "in" /* IN */ , "array-contains-any" /* ARRAY_CONTAINS_ANY */ ], 2, e), i = Bi("Query.where", t), r = or(this.c_, "Query.where", this.firestore.Gl, this.firestore.Gc, i, s, n);
        return new _r(function(t, e) {
    ...
    orderBy(t, e) {
        let n;
        if (Ks("Query.orderBy", arguments, 1, 2), Ys("Query.orderBy", "non-empty string", 2, e), 
        ...
        const s = Bi("Query.orderBy", t), i = hr(this.c_, s, n);
        return new _r(function(t, e) {
    ...
    limit(t) {
        return Gs("Query.limit", arguments, 1), Hs("Query.limit", "number", 1, t), ai("Query.limit", 1, t), 
        new _r(wn(this.c_, t, "F" /* First */), this.firestore, this.Kc);
    }
    limitToLast(t) {
        return Gs("Query.limitToLast", arguments, 1), Hs("Query.limitToLast", "number", 1, t), 
        ai("Query.limitToLast", 1, t), new _r(wn(this.c_, t, "L" /* Last */), this.firestore, this.Kc);
    }
    startAt(t, ...e) {
        zs("Query.startAt", arguments, 1);
        const n = this.l_("Query.startAt", t, e, 
        /*before=*/ !0);
        return new _r(Tn(this.c_, n), this.firestore, this.Kc);
    }
    startAfter(t, ...e) {
        zs("Query.startAfter", arguments, 1);
        const n = this.l_("Query.startAfter", t, e, 
        /*before=*/ !1);
        return new _r(Tn(this.c_, n), this.firestore, this.Kc);
    }
    endBefore(t, ...e) {
        zs("Query.endBefore", arguments, 1);
        const n = this.l_("Query.endBefore", t, e, 
        /*before=*/ !0);
        return new _r(mn(this.c_, n), this.firestore, this.Kc);
    }
    endAt(t, ...e) {
        zs("Query.endAt", arguments, 1);
        const n = this.l_("Query.endAt", t, e, 
        /*before=*/ !1);
        return new _r(mn(this.c_, n), this.firestore, this.Kc);
    }
    isEqual(t) {
        if (!(t instanceof _r)) throw hi("isEqual", "Query", 1, t);
        return this.firestore === t.firestore && En(this.c_, t.c_) && this.Kc === t.Kc;
    }
    withConverter(t) {
        return new _r(this.c_, this.firestore, t);
    }
    /** Helper function to create a bound from a document or fields */    l_(t, e, n, s) {
        if (ri(t, 1, e), e instanceof ir) return Gs(t, [ e, ...n ], 1), function(t, e, n, s, i) {
 ...
 */ (this.c_, this.firestore.Gc, t, e.h_, s);
    ...
    onSnapshot(...t) {
        var e, n, s;
        Ks("Query.onSnapshot", arguments, 1, 4);
        let i = {}, r = 0;
        if ("object" != typeof t[r] || Ws(t[r]) || (i = t[r], oi("Query.onSnapshot", i, [ "includeMetadataChanges" ]), 
        Js("Query.onSnapshot", "boolean", "includeMetadataChanges", i.includeMetadataChanges), 
        r++), Ws(t[r])) {
            const i = t[r];
            t[r] = null === (e = i.next) || void 0 === e ? void 0 : e.bind(i), t[r + 1] = null === (n = i.error) || void 0 === n ? void 0 : n.bind(i), 
            t[r + 2] = null === (s = i.complete) || void 0 === s ? void 0 : s.bind(i);
        } else Hs("Query.onSnapshot", "function", r, t[r]), Ys("Query.onSnapshot", "function", r + 1, t[r + 1]), 
        Ys("Query.onSnapshot", "function", r + 2, t[r + 2]);
        const o = {
            next: e => {
                t[r] && t[r](new fr(this.firestore, this.c_, e, this.Kc));
            },
            error: t[r + 1],
            complete: t[r + 2]
        };
    ...
    get(t) {
        Ks("Query.get", arguments, 0, 1), mr("Query.get", t), lr(this.c_);
        const e = this.firestore.Ml();
        return (t && "cache" === t.source ? e.pl(this.c_) : e.yl(this.c_, t)).then(t => new fr(this.firestore, this.c_, t, this.Kc));
    }
}
...
class fr {
    constructor(t, e, n, s) {
        ...
        this.metadata = new sr(n.hasPendingWrites, n.fromCache);
    }
    get docs() {
        const t = [];
    ...
    forEach(t, e) {
        Ks("QuerySnapshot.forEach", arguments, 1, 2), Hs("QuerySnapshot.forEach", "function", 1, t), 
        this.f_.docs.forEach(n => {
            t.call(e, this.T_(n, this.metadata.fromCache, this.f_.qt.has(n.key)));
        });
    }
    get query() {
        return new _r(this.__, this.e_, this.Kc);
    }
    docChanges(t) {
        t && (oi("QuerySnapshot.docChanges", t, [ "includeMetadataChanges" ]), Js("QuerySnapshot.docChanges", "boolean", "includeMetadataChanges", t.includeMetadataChanges));
 ...
 */
    ...
    /** Check the equality. The call can be very expensive. */    isEqual(t) {
        if (!(t instanceof fr)) throw hi("isEqual", "QuerySnapshot", 1, t);
        return this.e_ === t.e_ && En(this.__, t.__) && this.f_.isEqual(t.f_) && this.Kc === t.Kc;
    }
    T_(t, e, n) {
        return new rr(this.e_, t.key, t, e, n, this.Kc);
    }
}
...
class dr extends _r {
    ...
    get parent() {
        ...
        return t._() ? null : new nr(new B(t), this.firestore, 
        /* converter= */ null);
    }
    get path() {
    ...
    doc(t) {
        Ks("CollectionReference.doc", arguments, 0, 1), 
        // We allow omission of 'pathString' but explicitly prohibit passing in both
        // 'undefined' and 'null'.
        0 === arguments.length && (t = y.t()), Hs("CollectionReference.doc", "non-empty string", 1, t);
        const e = q.$(t);
        return nr.Zl(this.c_.path.child(e), this.firestore, this.Kc);
    }
    add(t) {
        Gs("CollectionReference.add", arguments, 1);
        Hs("CollectionReference.add", "object", 1, this.Kc ? this.Kc.toFirestore(t) : t);
        const e = this.doc();
        return e.set(t).then(() => e);
    }
    withConverter(t) {
        return new dr(this.m_, this.firestore, t);
    }
}
...
function wr(t, e) {
    ...
    if (oi(t, e, [ "merge", "mergeFields" ]), Js(t, "boolean", "merge", e.merge), Zs(t, "mergeFields", "a string or a FieldPath", e.mergeFields, t => "string" == typeof t || t instanceof wi), 
...
function Tr(t, e) {
    return void 0 === e ? {} : (oi(t, e, [ "serverTimestamps" ]), ti(t, 0, "serverTimestamps", e.serverTimestamps, [ "estimate", "previous", "none" ]), 
    e);
}

function mr(t, e) {
    Ys(t, "object", 1, e), e && (oi(t, e, [ "source" ]), ti(t, 0, "source", e.source, [ "default", "server", "cache" ]));
}
...
function Er(t, e, n) {
    ...
    throw hi(t, "DocumentReference", 1, e);
}
...
function Pr(t) {
    ...
    }(t, (t, e) => new Zi(t, e, new Us, new Bs)), t.registerVersion("@firebase/firestore", "1.16.3");
}
