...
/** A dot-separated path for navigating sub-objects within a document. */ class B extends q {
    V(t, e, n) {
        return new B(t, e, n);
    }
    /**
...
function Y(t, e) {
    ...
    for (let n = 0; n < t.orderBy.length; n++) if (!On(t.orderBy[n], e.orderBy[n])) return !1;
 ...
 */ class pt {
    ...
    static zt(t, e) {
        const n = new Map;
        return n.set(t, yt.Kt(t, e)), new pt(O.min(), n, Rt(), _t(), mt());
    }
}
...
class Ct {
     ...
     */    Pe(t) {
        for (const e of t.Zt) t.te instanceof an ? this.Ve(e, t.te) : t.te instanceof un && this.pe(e, t.key, t.te);
        ...
        this.me.forEach((n, s) => {
            ...
            if (i) {
                if (n.Ht && X(i.target)) {
                    ...
                    null !== this.Ie.get(e) || this.$e(s, e) || this.pe(s, e, new un(e, t));
                }
    ...
    ve(t) {
        let e = this.me.get(t);
        return e || (e = new St, this.me.set(t, e)), e;
    }
    ke(t) {
        let e = this.Re.get(t);
 ...
 */ (n, e) : t instanceof Ce ? De(t, e) : t instanceof Fe ? Ne(t, e) : function(t, e) {
        ...
        const n = be(t, e), s = ke(n) + ke(t.Me);
        return zt(n) && zt(t.Me) ? ee(s) : ne(t.serializer, s);
    }(t, e);
}
 ...
 */ function be(t, e) {
    return t instanceof $e ? zt(n = e) || function(t) {
...
/** Transforms an array value via a union operation. */ class Ce extends ye {
    constructor(t) {
...
/** Transforms an array value via a remove operation. */ class Fe extends ye {
    constructor(t) {
        super(), this.elements = t;
    }
}
...
function qe(t, e) {
    return t.field.isEqual(e.field) && function(t, e) {
        return t instanceof Ce && e instanceof Ce || t instanceof Fe && e instanceof Fe ? b(t.elements, e.elements, Lt) : t instanceof $e && e instanceof $e ? Lt(t.Me, e.Me) : t instanceof Se && e instanceof Se;
    }(t.transform, e.transform);
}

/** The result of successfully applying a mutation to the backend. */ class Me {
    constructor(
    /**
...
function ze(t, e) {
    return t.type === e.type && (!!t.key.isEqual(e.key) && (!!t.Be.isEqual(e.Be) && (0 /* Set */ === t.type ? t.value.isEqual(e.value) : 1 /* Patch */ === t.type ? t.data.isEqual(e.data) && t.qe.isEqual(e.qe) : 2 /* Transform */ !== t.type || b(t.fieldTransforms, t.fieldTransforms, (t, e) => qe(t, e)))));
}
 ...
 */ class rn {
    ...
    /** Returns an ObjectValue with all mutations applied. */    ze() {
        ...
        return null != t ? new sn(t) : this.Ke;
    }
    /**
     ...
     */    Xe(t, e) {
        let n = !1;
        const s = this.Ke.field(t), i = Xt(s) ? // If there is already data at the current path, base our
 ...
 */ function wn(t) {
    ...
    if (null === e.nn) {
        ...
        t.O() || e.nn.push(new xn(t)), e.nn.push(new xn(B.q(), "asc" /* ASCENDING */)); else {
            let t = !1;
 ...
 */ function Tn(t) {
    const e = ln(t, _n);
    if (!e.sn) if ("F" /* First */ === e.en) e.sn = z(e.path, e.collectionGroup, wn(e), e.filters, e.limit, e.startAt, e.endAt); else {
        ...
        // We need to swap the cursors to match the now-flipped query ordering.
                const n = e.endAt ? new Fn(e.endAt.position, !e.endAt.before) : null, s = e.startAt ? new Fn(e.startAt.position, !e.startAt.before) : null;
        // Now return as a LimitType.First query.
        e.sn = z(e.path, e.collectionGroup, t, e.filters, e.limit, n, s);
    }
    return e.sn;
}
 ...
 */ (t, e) && function(t, e) {
    ...
    /** Makes sure a document is within the bounds, if provided. */ (t, e) && function(t, e) {
        if (t.startAt && !$n(t.startAt, wn(t), e)) return !1;
        if (t.endAt && $n(t.endAt, wn(t), e)) return !1;
        return !0;
    }
    /**
...
class yn extends class {} {
     ...
     */    static create(t, e, n) {
        if (t.O()) return "in" /* IN */ === e ? new bn(t, n) : new vn(t, e, n);
        if (Ht(n)) {
        ...
        return "array-contains" /* ARRAY_CONTAINS */ === e ? new Sn(t, n) : "in" /* IN */ === e ? new Cn(t, n) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new Dn(t, n) : new yn(t, e, n);
    }
    matches(t) {
        const e = t.field(this.field);
        // Only compare types with matching backend order (such as double and int).
                return null !== e && xt(this.value) === xt(e) && this.fn(qt(e, this.value));
    }
    fn(t) {
        switch (this.op) {
          case "<" /* LESS_THAN */ :
...
/** Filter that matches on key fields within an array. */ class bn extends yn {
    constructor(t, e) {
        super(t, "in" /* IN */ , e), this.keys = (e.arrayValue.values || []).map(t => W.U(t.referenceValue));
    }
    matches(t) {
...
/** A Filter that implements the array-contains operator. */ class Sn extends yn {
    constructor(t, e) {
        super(t, "array-contains" /* ARRAY_CONTAINS */ , e);
    }
    matches(t) {
        const e = t.field(this.field);
        return Kt(e) && Ot(e.arrayValue, this.value);
    }
}

/** A Filter that implements the IN operator. */ class Cn extends yn {
    constructor(t, e) {
        super(t, "in" /* IN */ , e);
    }
    matches(t) {
...
/** A Filter that implements the array-contains-any operator. */ class Dn extends yn {
    constructor(t, e) {
        super(t, "array-contains-any" /* ARRAY_CONTAINS_ANY */ , e);
    }
    matches(t) {
        const e = t.field(this.field);
        return !(!Kt(e) || !e.arrayValue.values) && e.arrayValue.values.some(t => Ot(this.value.arrayValue, t));
    }
}
...
class qn {
     ...
     */    En(t, e) {
        ...
        for (const n of this.baseMutations) n.key.isEqual(t) && (e = je(n, e, e, this.dn));
        const n = e;
        // Second, apply all user-provided mutations.
                for (const s of this.mutations) s.key.isEqual(t) && (e = je(s, e, n, this.dn));
        return e;
    }
    /**
    ...
    isEqual(t) {
        return this.batchId === t.batchId && b(this.mutations, t.mutations, (t, e) => ze(t, e)) && b(this.baseMutations, t.baseMutations, (t, e) => ze(t, e));
    }
}

/** The result of applying a mutation batch to the backend. */ class Mn {
    constructor(t, e, n, 
    /**
 ...
 */ class Un {
    ...
    next(t, e) {
        return this.pn && P(), this.pn = !0, this.Vn ? this.error ? this.yn(e, this.error) : this.gn(t, this.result) : new Un((n, s) => {
            this.An = e => {
    ...
    bn(t) {
        try {
            const e = t();
            return e instanceof Un ? e : Un.resolve(e);
        } catch (t) {
            return Un.reject(t);
        }
    }
    gn(t, e) {
        return t ? this.bn(() => t(e)) : Un.resolve(e);
    }
    yn(t, e) {
        return t ? this.bn(() => t(e)) : Un.reject(e);
    }
    static resolve(t) {
        return new Un((e, n) => {
            e(t);
     ...
     */    static Cn(t) {
        let e = Un.resolve(!1);
        for (const n of t) e = e.next(t => t ? Un.resolve(t) : n());
        return e;
    }
    static forEach(t, e) {
        const n = [];
 ...
 */
        return function(t) {
            return W.W(t.path) && null === t.collectionGroup && 0 === t.filters.length;
        }(e) ? this.Wn(t, e.path) : dn(e) ? this.Qn(t, e, n) : this.jn(t, e, n);
    }
    Wn(t, e) {
        // Just do a simple document lookup.
        return this.$n(t, new W(e)).next(t => {
            let e = wt();
    ...
    Qn(t, e, n) {
        ...
        let i = wt();
        return this.Nn.Gn(t, s).next(r => Un.forEach(r, r => {
    ...
    jn(t, e, n) {
        ...
        this.Kn(t, i, s).next(t => {
            ...
            for (const t of i) for (const e of t.mutations) {
                const n = e.key, i = s.get(n), r = je(e, i, i, t.dn);
 ...
 */ class Wn {
 ...
 // do nothing
        ...
        return new Wn(t, e.fromCache, n, s);
    }
}
...
class Gn {
     ...
     */    fs(t) {
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                s > 0 && m("ExponentialBackoff", `Backing off for ${s} ms (base delay: ${this.us} ms, delay with jitter: ${e} ms, last attempt: ${n} ms ago)`), 
 ...
 */ class zn {
    ...
    Is(t, e) {
        return this.ms.add(e), Un.resolve();
    }
    Gn(t, e) {
        return Un.resolve(this.ms.getEntries(e));
    }
}
 ...
 */ class Kn {
    ...
    add(t) {
        const e = t.S(), n = t.g(), s = this.index[e] || new ut(M.P), i = !s.has(n);
    ...
    getEntries(t) {
        return (this.index[t] || new ut(M.P)).F();
    }
}
 ...
 * limitations under the License.
 */
/** The Platform's 'window' implementation or null if not available. */ function Xn() {
...
class Jn {
    constructor(t, e, n, s, i) {
        this.Vs = t, this.rs = e, this.ps = n, this.op = s, this.ys = i, this.gs = new jn, 
     ...
     */    cancel(t) {
        null !== this.bs && (this.clearTimeout(), this.gs.reject(new x(k.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
    }
    Ss() {
...
class Zn {
     ...
     */    enqueue(t) {
        return this.Bs(), this.Ns ? new Promise(t => {}) : this.Ws(t);
    }
    /**
 ...
 */ (t)), t;
     ...
     */    ws(t, e, n) {
        ...
        const s = Jn.vs(this, t, e, n, t => this.Ks(t));
        return this.$s.push(s), s;
    }
    Bs() {
        this.ks && P();
    }
     ...
     * exists.
     */    Xs(t) {
        for (const e of this.$s) if (e.rs === t) return !0;
        return !1;
    }
    /**
     ...
     */    Js(t) {
        ...
        return this.Ys().then(() => {
            ...
            this.$s.sort((t, e) => t.ps - e.ps);
            for (const e of this.$s) if (e.Es(), "all" /* All */ !== t && e.rs === t) break;
            return this.Ys();
        });
    }
    /**
...
class es {
    ...
    static si(t) {
        return new es(t, es.ii, es.ri);
    }
}

es.oi = -1, es.hi = 1048576, es.ai = 41943040, es.ii = 10, es.ri = 1e3, es.ui = new es(es.ai, es.ii, es.ri), 
es.ci = new es(es.oi, 0, 0);
...
class ns {
    ...
    t, e, n) {
         ...
         */
        this.di = O.min(), this.Fn = t.wi(n), this.Ti = t.Ei(), this.mi = t.Ii(), this.Ri = new Bn(this.Ti, this.Fn, this.persistence.Ai()), 
        this.li.Pi(this.Ri);
    }
    async Vi(t) {
        ...
        const s = await this.persistence.runTransaction("Handle user change", "readonly", s => {
            ...
            // MutationQueue.
            n = new Bn(this.Ti, e, this.persistence.Ai()), e.pi(s))).next(t => {
                const e = [], r = [];
    ...
    bi(t) {
        const e = L.now(), n = t.reduce((t, e) => t.add(e.key), mt());
        let s;
    ...
    Di(t) {
        return this.persistence.runTransaction("Acknowledge batch", "readwrite-primary", e => {
            ...
            return this.$i(e, t, s).next(() => s.apply(e)).next(() => this.Fn.ki(e)).next(() => this.Ri.qn(e, n));
        });
    }
    xi(t) {
        return this.persistence.runTransaction("Reject batch", "readwrite-primary", e => {
            let n;
            return this.Fn.Li(e, t).next(t => (V(null !== t), n = t.keys(), this.Fn.Oi(e, t))).next(() => this.Fn.ki(e)).next(() => this.Ri.qn(e, n));
        });
    }
    qi() {
        ...
        return this.persistence.runTransaction("Apply remote event", "readwrite-primary", s => {
            ...
            t.Wt.forEach((t, i) => {
                ...
                // Update the resume token if the change includes one.
                    ...
                    ns.ji(o, a, t) && r.push(this.mi.Gi(s, a));
                }
            });
            let o = _t(), h = mt();
            ...
            return Un.Sn(r).next(() => i.apply(s)).next(() => this.Ri.Mn(s, o));
        }).then(t => (this._i = n, t));
    }
    /**
    ...
    async Zi(t) {
        try {
            await this.persistence.runTransaction("notifyLocalViewChanges", "readwrite", e => Un.forEach(t, t => Un.forEach(t.Hn, n => this.persistence.Yi.tr(e, t.targetId, n)).next(() => Un.forEach(t.Yn, n => this.persistence.Yi.er(e, t.targetId, n)))));
        } catch (t) {
            if (!Yn(t)) throw t;
    ...
    ir(t) {
        return this.persistence.runTransaction("read document", "readonly", e => this.Ri.$n(e, t));
    }
    rr(t) {
        return this.persistence.runTransaction("Allocate target", "readwrite", e => {
            ...
            n = s, Un.resolve(n)) : this.mi.hr(e).next(s => (n = new tt(t, s, 0 /* Listen */ , e.Qi), 
    ...
    or(t, e) {
        ...
        return void 0 !== n ? Un.resolve(this._i.get(n)) : this.mi.or(t, e);
    }
    async ur(t, e) {
    ...
    cr(t, e) {
        ...
        }).next(() => this.li.Bn(i, t, e ? n : O.min(), e ? s : mt())).next(t => ({
            documents: t,
            _r: s
        })));
    }
...
class is {
    constructor() {
        ...
        this.Tr = new ut(rs.Er), 
        // A set of outstanding references to a document sorted by target id.
        this.mr = new ut(rs.Ir);
    }
     ...
     * removed.
     */    Vr(t) {
        const e = new W(new M([])), n = new rs(e, t), s = new rs(e, t + 1), i = [];
    ...
    yr(t) {
        const e = new W(new M([])), n = new rs(e, t), s = new rs(e, t + 1);
        let i = mt();
        return this.mr.bt([ n, s ], t => {
            i = i.add(t.key);
        }), i;
    ...
    gr(t) {
        const e = new rs(t, 0), n = this.Tr.Ct(e);
...
/** A user with a null UID. */ os.UNAUTHENTICATED = new os(null), 
// TODO(mikelehen): Look into getting a proper uid-equivalent for
// non-FirebaseAuth providers.
os.Cr = new os("google-credentials-uid"), os.Dr = new os("first-party-uid");
...
/** A CredentialsProvider that always yields an empty token. */ class as {
    constructor() {
        /**
...
class us {
    constructor(t) {
        ...
        this.currentUser = os.UNAUTHENTICATED, this.Or = !1, 
        /**
        ...
        this.Nr = null, this.forceRefresh = !1, this.Lr = () => {
            this.qr++, this.currentUser = this.Mr(), this.Or = !0, this.Nr && this.Nr(this.currentUser);
    ...
    getToken() {
        ...
        this.qr !== t ? (m("FirebaseCredentialsProvider", "getToken aborted due to token change."), 
        this.getToken()) : e ? (V("string" == typeof e.accessToken), new hs(e.accessToken, this.currentUser)) : null) : Promise.resolve(null);
    }
    $r() {
        this.forceRefresh = !0;
    }
    ...
    Mr() {
        ...
        return V(null === t || "string" == typeof t), new os(t);
    }
}
 ...
 */ class cs {
    constructor(t, e) {
        this.Ur = t, this.Br = e, this.type = "FirstParty", this.user = os.Dr;
    }
    get Fr() {
        const t = {
 ...
 */ class ls {
    ...
    getToken() {
        return Promise.resolve(new cs(this.Ur, this.Br));
    }
    kr(t) {
...
class _s {
     ...
     */    ro(t) {
        return e => {
            this.ss.Cs(() => this.zr === t ? e() : (m("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
            Promise.resolve()));
        };
    }
}
 ...
 */ class ds extends _s {
    ...
    onMessage(t) {
        ...
        V(!!t.streamToken), this.lastStreamToken = t.streamToken, this.do) {
            ...
            this.Os.reset();
            const e = Ee(t.writeResults, t.commitTime), n = he(t.commitTime);
            return this.listener.Eo(n, e);
        }
        // The first response is always the handshake response
        return V(!t.writeResults || 0 === t.writeResults.length), this.do = !0, this.listener.mo();
    }
    /**
...
class Ts {
    ...
    Fo(t) {
        ...
        this.So ? (I(e), this.So = !1) : m("OnlineStateTracker", e);
    }
    $o() {
    ...
    e, n, s, i) {
        ...
        this.Mo = new Set, this.Uo = i, this.Uo.Bo(t => {
            n.Cs(async () => {
                ...
                // down our streams.
                this.Wo() && (m("RemoteStore", "Restarting streams for network reachability change."), 
                await this.Qo());
            });
        }), this.jo = new Ts(n, s), 
        ...
        this.Go = function(t, e, n) {
            const s = p(t);
            return s.Ao(), new fs(e, s.jr, s.credentials, s.serializer, n);
        }
        /**
 * @license
 * Copyright 2018 Google LLC
 ...
 */ (this.xo, n, {
    ...
    async ih() {
        await this.Yo.stop(), await this.Go.stop(), this.Lo.length > 0 && (m("RemoteStore", `Stopping write stream with ${this.Lo.length} pending writes`), 
        this.Lo = []), this.rh();
    }
    async oh() {
        m("RemoteStore", "RemoteStore shutting down."), this.Mo.add(5 /* Shutdown */), await this.ih(), 
        this.Uo.oh(), 
    ...
    nh() {
        this.qo = new Ct(this), this.Go.start(), this.jo.Co();
    }
    /**
    ...
    async Ho(t, e) {
        ...
        this.jo.set("Online" /* Online */), t instanceof bt && 2 /* Removed */ === t.state && t.cause) 
        ...
        try {
            ...
            await this.fh(e);
        } else if (t instanceof gt ? this.qo.Pe(t) : t instanceof vt ? this.qo.Ce(t) : this.qo.ye(t), 
        !e.isEqual(O.min())) try {
            ...
            m("RemoteStore", "Failed to raise snapshot:", t), await this.fh(t);
        }
    }
    /**
    ...
    async Eo(t, e) {
        const n = this.Lo.shift(), s = Mn.from(n, t, e);
 ...
 */ class Is {
    constructor() {
        this.Ch = new ms, this.Dh = {}, this.yo = null, this.Jn = null;
    }
    Fh(t) {
        // No op.
    }
    ...
    start() {
        return this.Ch = new ms, Promise.resolve();
    }
    Vi(t, e, n) {
        // No op.
    }
 ...
 */ class Ps {
    ...
    e) {
        ...
        this.qt = mt(), this.jh = pn(t), this.Gh = new At(this.jh);
    }
    /**
     ...
     */    Kh(t, e) {
        const n = e ? e.Hh : new Pt, s = e ? e.Gh : this.Gh;
 ...
 */ (t.type, e.type) || this.jh(t.doc, e.doc)), this.Zh(n);
        ...
        if (this.Wh = o, 0 !== i.length || h) {
            return {
                snapshot: new Vt(this.query, t.Gh, s, i, t.qt, 0 /* Local */ === o, h, 
                /* excludesMetadataChanges= */ !1),
                ea: r
            };
        }
    ...
    ta() {
        ...
        // updating many documents.
                const t = this.Qh;
        this.Qh = mt(), this.Gh.forEach(t => {
            this.sa(t.key) && (this.Qh = this.Qh.add(t.key));
        });
        // Diff the new limbo docs with the old limbo docs.
        const e = [];
        return t.forEach(t => {
            this.Qh.has(t) || e.push(new As(t));
        }), this.Qh.forEach(n => {
            t.has(n) || e.push(new Rs(n));
        }), e;
    }
    /**
    ...
    // PORTING NOTE: Multi-tab only.
    ra() {
        return Vt.Bt(this.query, this.Gh, this.qt, 0 /* Local */ === this.Wh);
    }
}
 ...
 */ class ys {
    ...
    s, i, r) {
        ...
        this.ca = null, this.la = new $(t => An(t), Rn), this._a = new Map, 
        /**
         ...
         */
        this.wa = new Map, this.Ta = new is, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.Ea = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.ma = new Map, this.Ia = Hn.Ps(), this.onlineState = "Unknown" /* Unknown */ , 
    ...
    async listen(t) {
        ...
        e = s.targetId, this.aa.$h(e), n = s.view.ra(); else {
            const s = await this.ko.rr(Tn(t)), i = this.aa.$h(s.targetId);
     ...
     */    async Va(t, e, n) {
        ...
        /* usePreviousResults= */ !0), i = new Ps(t, s._r), r = i.Kh(s.documents), o = yt.Kt(e, n && "Offline" /* Offline */ !== this.onlineState), h = i.Jh(r, 
        /* updateLimboDocuments= */ this.Aa, o);
        this.pa(e, h.ea);
        const a = new Vs(t, e, i);
    ...
    async ah(t) {
        ...
        // to the target.
                if (n.length > 1) return this._a.set(e.targetId, n.filter(e => !Rn(e, t))), 
    ...
    async Ui(t) {
        ...
        try {
            ...
            // Update `receivedDocument` as appropriate for any limbo targets.
                ...
                V(t.Yt.size + t.Xt.size + t.Jt.size <= 1), t.Yt.size > 0 ? n.oa = !0 : t.Xt.size > 0 ? V(n.oa) : t.Jt.size > 0 && (V(n.oa), 
                n.oa = !1));
            }), await this.va(e, t);
        } catch (t) {
            await ss(t);
    ...
    async Th(t, e) {
        ...
        if (s) {
            ...
            const n = mt().add(s), i = new pt(O.min(), 
        ...
        } else await this.ko.ur(t, /* keepPersistedTargetData */ !1).then(() => this.ya(t, e)).catch(ss);
    }
    async Ph(t) {
        ...
        try {
            ...
            // before listen events.
                        this.Ca(e, /*error=*/ null), this.Da(e), this.aa.Nh(e, "acknowledged"), 
            await this.va(n);
        } catch (t) {
            await ss(t);
        }
    ...
    async ph(t, e) {
        ...
        try {
            ...
            // listen events.
                        this.Ca(t, e), this.Da(t), this.aa.Nh(t, "rejected", e), await this.va(n);
        } catch (e) {
            await ss(e);
        }
    }
    async Fa(t) {
        this.ha.Wo() || m("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled.");
        try {
    ...
    /** Reject all outstanding callbacks waiting for pending writes to complete. */    Na(t) {
        this.ma.forEach(e => {
            e.forEach(e => {
    ...
    ga(t, e) {
        ...
        n || (n = new ot(v)), n = n.nt(t, e), this.Ea[this.currentUser.Sr()] = n;
    }
    /**
    ...
    ya(t, e = null) {
        this.aa.xh(t);
        for (const n of this._a.get(t)) this.la.delete(n), e && this.ca.$a(n, e);
    ...
    pa(t, e) {
        for (const n of e) if (n instanceof Rs) this.Ta.tr(n.key, t), this.xa(n); else if (n instanceof As) {
            m("SyncEngine", "Document no longer in limbo: " + n.key), this.Ta.er(n.key, t);
            this.Ta.gr(n.key) || 
            // We removed the last reference for this key
            this.ka(n.key);
        } else P();
    ...
    xa(t) {
        const e = t.key;
        this.da.get(e) || (m("SyncEngine", "New document in limbo: " + e), this.fa.push(e), 
        this.Sa());
    }
    /**
     ...
     */    Sa() {
        for (;this.fa.length > 0 && this.da.size < this.ua; ) {
            ...
            this.wa.set(e, new ps(t)), this.da = this.da.nt(t, e), this.ha.listen(new tt(Tn(fn(t.path)), e, 2 /* LimboResolution */ , Qn.ns));
        }
    }
    // Visible for testing
    La() {
        ...
        this.la.forEach((r, o) => {
            i.push(Promise.resolve().then(() => {
                ...
                if (this.pa(o.targetId, r.ea), r.snapshot) {
                    ...
                    n.push(r.snapshot);
                    const t = Wn.Xn(o.targetId, r.snapshot);
                    s.push(t);
                }
            }));
 ...
 */ class vs {
    constructor(t) {
        this.lh = t, this.Ma = new $(t => An(t), Rn), this.onlineState = "Unknown" /* Unknown */ , 
        this.Ua = new Set, this.lh.subscribe(this);
    }
    async listen(t) {
        const e = t.query;
        let n = !1, s = this.Ma.get(e);
        if (s || (n = !0, s = new gs), n) try {
 ...
 */ class bs {
     ...
     */    Ba(t) {
        if (!this.options.includeMetadataChanges) {
            ...
            t = new Vt(t.query, t.docs, t.Ot, e, t.qt, t.fromCache, t.Mt, 
    ...
    Xa(t) {
        t = Vt.Bt(t.query, t.docs, t.qt, t.fromCache), this.za = !0, this.Ga.next(t);
    }
}
 ...
 */ class Ss {
    ...
    Bn(t, e, s, i) {
        ...
        return e.on() || s.isEqual(O.min()) ? this.tu(t, e) : this.Za.qn(t, i).next(r => {
            const o = this.eu(e, r);
            return (e.hn() || e.an()) && this.Xh(e.en, o, i, s) ? this.tu(t, e) : (E() <= n.DEBUG && m("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", s.toString(), Pn(e)), 
    ...
    tu(t, e) {
        return E() <= n.DEBUG && m("IndexFreeQueryEngine", "Using full collection scan to execute query:", Pn(e)), 
        this.Za.Bn(t, e, O.min());
    }
}
 ...
 */ class Cs {
    constructor(t, e) {
        ...
        this.su = new ut(rs.Er);
    }
    iu(t) {
        return Un.resolve(0 === this.Fn.length);
    }
    Si(t, e, n, s) {
        const i = this.nu;
        ...
        for (const e of s) this.su = this.su.add(new rs(e.key, i)), this.Nn.Is(t, e.key.path.g());
        return Un.resolve(r);
    }
    Li(t, e) {
        return Un.resolve(this.ru(e));
    }
    sr(t, e) {
        const n = e + 1, s = this.ou(n), i = s < 0 ? 0 : s;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return Un.resolve(this.Fn.length > i ? this.Fn[i] : null);
    }
    qi() {
        return Un.resolve(0 === this.Fn.length ? -1 : this.nu - 1);
    }
    pi(t) {
        return Un.resolve(this.Fn.slice());
    }
    kn(t, e) {
        const n = new rs(e, 0), s = new rs(e, Number.POSITIVE_INFINITY), i = [];
    ...
    Un(t, e) {
        let n = new ut(v);
        return e.forEach(t => {
            const e = new rs(t, 0), s = new rs(t, Number.POSITIVE_INFINITY);
            this.su.bt([ e, s ], t => {
                n = n.add(t.vr);
            });
        }), Un.resolve(this.hu(n));
    }
    zn(t, e) {
    ...
    Oi(t, e) {
        V(0 === this.au(e.batchId, "removed")), this.Fn.shift();
        let n = this.su;
        return Un.forEach(e.mutations, s => {
            const i = new rs(s.key, e.batchId);
    ...
    gr(t, e) {
        const n = new rs(e, 0), s = this.su.Ct(n);
        return Un.resolve(e.isEqual(s && s.key));
    }
    ki(t) {
        return this.Fn.length, Un.resolve();
    }
    /**
 ...
 */ class Ds {
     ...
     */    Ki(t, e, n) {
        ...
        return this.docs = this.docs.nt(s, {
            ...
            size: o,
            readTime: n
        }), this.size += o - r, this.Nn.Is(t, s.path.g());
    }
    /**
    ...
    fu(t, e) {
        return Un.forEach(this.docs, t => e(t));
    }
    Fi(t) {
        // `trackRemovals` is ignores since the MemoryRemoteDocumentCache keeps
        // a separate changelog and does not need special handling for removals.
        return new Ds.du(this);
    }
    wu(t) {
        return Un.resolve(this.size);
    }
}

/**
 * Handles the details of adding and updating documents in the MemoryRemoteDocumentCache.
 */ Ds.du = class extends class {
    constructor() {
     ...
     */    Ln(t, e) {
        ...
        return void 0 !== n ? Un.resolve(n) : this.Iu(t, e);
    }
    /**
...
class Fs {
    constructor(t) {
         ...
         * IDs.
         */
        this.pu = new is, this.targetCount = 0, this.yu = Hn.As();
    }
    ge(t, e) {
        return this.Pu.forEach((t, n) => e(n)), Un.resolve();
    }
    Mi(t) {
        return Un.resolve(this.lastRemoteSnapshotVersion);
    }
    gu(t) {
        return Un.resolve(this.Vu);
    }
    hr(t) {
        return this.highestTargetId = this.yu.next(), Un.resolve(this.highestTargetId);
    }
    Xi(t, e, n) {
    ...
    vu(t) {
        ...
        const e = t.targetId;
        e > this.highestTargetId && (this.yu = new Hn(e), this.highestTargetId = e), t.sequenceNumber > this.Vu && (this.Vu = t.sequenceNumber);
    }
    ar(t, e) {
        return this.vu(e), this.targetCount += 1, Un.resolve();
    }
    Gi(t, e) {
        return this.vu(e), Un.resolve();
    }
    bu(t, e) {
    ...
    Du(t) {
        return Un.resolve(this.targetCount);
    }
    or(t, e) {
    ...
    Wi(t, e, n) {
        return this.pu.Rr(e, n), Un.resolve();
    }
    Bi(t, e, n) {
        this.pu.Pr(e, n);
    ...
    Cu(t, e) {
        return this.pu.Vr(e), Un.resolve();
    }
    lr(t, e) {
    ...
    gr(t, e) {
        return Un.resolve(this.pu.gr(e));
    }
}
...
class Ns {
     ...
     */
    constructor(t) {
        this.Fu = {}, this.Nu = new Qn(0), this.$u = !1, this.$u = !0, this.Yi = t(this), 
        this.mi = new Fs(this);
        this.Nn = new zn, this.Dn = new Ds(this.Nn, t => this.Yi.ku(t));
    }
    start() {
    ...
    wi(t) {
        let e = this.Fu[t.Sr()];
        return e || (e = new Cs(this.Nn, this.Yi), this.Fu[t.Sr()] = e), e;
    }
    Ii() {
        return this.mi;
    }
    ...
    runTransaction(t, e, n) {
        ...
        const s = new $s(this.Nu.next());
        return this.Yi.qu(), n(s).next(t => this.Yi.Mu(s).next(() => t)).vn().then(t => (s.Uu(), 
        t));
    }
    Bu(t, e) {
        return Un.Cn(Object.values(this.Fu).map(n => () => n.gr(t, e)));
    }
}
...
class ks {
    ...
    tr(t, e, n) {
        return this.ju.tr(n, e), this.Ku.delete(n), Un.resolve();
    }
    er(t, e, n) {
        return this.ju.er(n, e), this.Ku.add(n), Un.resolve();
    }
    uu(t, e) {
        return this.Ku.add(e), Un.resolve();
    }
    removeTarget(t, e) {
    ...
    Mu(t) {
        ...
        return Un.forEach(this.Ku, n => this.Hu(t, n).next(t => {
            t || e.zi(n);
    ...
    Hu(t, e) {
        return Un.Cn([ () => Un.resolve(this.ju.gr(e)), () => this.persistence.Ii().gr(t, e), () => this.persistence.Bu(t, e) ]);
    }
}
 ...
 */ {
            ...
            o.listenOnce(l.COMPLETE, () => {
                try {
                    switch (o.getLastErrorCode()) {
                      ...
                      case _.TIMEOUT:
                        m("Connection", 'RPC "' + t + '" timed out'), r(new x(k.DEADLINE_EXCEEDED, "Request time out"));
                        break;
    ...
    co(t, e) {
        ...
        // enough the code is exception free.
            ...
            T || (T = !0, R("Connection", "WebChannel transport errored:", t), E.nc(new x(k.UNAVAILABLE, "The operation could not be completed")));
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const Bs = "You are using the memory-only build of Firestore. Persistence support is only available via the @firebase/firestore bundle or the firebase-firestore.js build.";
 ...
 */ class Ws {
    ...
    Ac(t) {
        /** Manages our in-memory or durable persistence. */
        return e = this.persistence, n = new Ss, s = t.Pc, new ns(e, n, s);
        var e, n, s;
    }
    mc(t) {
        if (t.pc.Vc) throw new x(k.FAILED_PRECONDITION, Bs);
        return new Ns(ks.zu);
    }
    Ec(t) {
        return new Is;
    ...
    clearPersistence(t, e) {
        throw new x(k.FAILED_PRECONDITION, Bs);
    }
}
 ...
 */ class Qs {
    ...
    gc(t) {
        return e = t.ic, Promise.resolve(new Os(e));
        var e;
        /** Return the Platform-specific connectivity monitor. */    }
    Cc(t) {
        return new vs(this.lh);
    }
    yc(t) {
        const e = Us(t.ic.s);
        return function(t, e) {
    ...
    vc(t) {
        return new Es(this.ko, this.xo, t.Vs, t => this.lh.na(t, 0 /* RemoteStore */), qs.Tc() ? new qs : new Ms);
    }
    bc(t) {
        return function(t, e, n, 
        // PORTING NOTE: Manages state synchronization in multi-tab environments.
        s, i, r, o) {
            const h = new ys(t, e, n, s, i, r);
            return o && (h.Ra = !0), h;
 ...
 */ function zs(t, e) {
    if (0 !== e.length) throw new x(k.INVALID_ARGUMENT, `Function ${t}() does not support arguments, but was called with ` + _i(e.length, "argument") + ".");
}
 ...
 */ function Ks(t, e, n) {
    if (e.length !== n) throw new x(k.INVALID_ARGUMENT, `Function ${t}() requires ` + _i(n, "argument") + ", but was called with " + _i(e.length, "argument") + ".");
}
 ...
 */ function Hs(t, e, n) {
    if (e.length < n) throw new x(k.INVALID_ARGUMENT, `Function ${t}() requires at least ` + _i(n, "argument") + ", but was called with " + _i(e.length, "argument") + ".");
}
 ...
 */ function Ys(t, e, n, s) {
    if (e.length < n || e.length > s) throw new x(k.INVALID_ARGUMENT, `Function ${t}() requires between ${n} and ` + s + " arguments, but was called with " + _i(e.length, "argument") + ".");
}
...
function ei(t, e, n, s, i) {
    void 0 !== s && function(t, e, n, s, i) {
        if (!(s instanceof Array)) throw new x(k.INVALID_ARGUMENT, `Function ${t}() requires its ${e} option to be an array, but it was: ` + oi(s));
        for (let r = 0; r < s.length; ++r) if (!i(s[r])) throw new x(k.INVALID_ARGUMENT, `Function ${t}() requires all ${e} elements to be ${n}, but the value at index ${r} was: ` + oi(s[r]));
    }(t, e, n, s, i);
}
 ...
 */ function si(t, e, n, s) {
    if (!e.some(t => t === s)) throw new x(k.INVALID_ARGUMENT, `Invalid value ${oi(s)} provided to function ${t}() for its ${li(n)} argument. Acceptable values: ` + e.join(", "));
    return s;
}

/** Helper to validate the type of a provided input. */ function ii(t, e, n, s) {
    let i = !1;
    if (i = "object" === e ? ri(s) : "non-empty string" === e ? "string" == typeof s && "" !== s : typeof s === e, 
    !i) {
        const i = oi(s);
...
/** Returns a string describing the type / value of the provided input. */ function oi(t) {
...
function hi(t, e, n) {
    if (void 0 === n) throw new x(k.INVALID_ARGUMENT, `Function ${t}() requires a valid ${li(e)} argument, but it was undefined.`);
}
 ...
 */ function ui(t, e, n, s) {
    const i = oi(s);
    return new x(k.INVALID_ARGUMENT, `Function ${t}() requires its ${li(n)} argument to be a ${e}, but it was: ${i}`);
}

function ci(t, e, n) {
    if (n <= 0) throw new x(k.INVALID_ARGUMENT, `Function ${t}() requires its ${li(e)} argument to be a positive number, but it was: ${n}.`);
}

/** Converts a number to its english word representation */ function li(t) {
    switch (t) {
      case 1:
        return "first";
 ...
 */ class di {
    ...
    static fromBase64String(t) {
        Ks("Blob.fromBase64String", arguments, 1), Xs("Blob.fromBase64String", "string", 1, t);
        try {
            return new di(Z.fromBase64String(t));
        } catch (t) {
            throw new x(k.INVALID_ARGUMENT, "Failed to construct Blob from Base64 string: " + t);
        }
    }
    static fromUint8Array(t) {
        if (Ks("Blob.fromUint8Array", arguments, 1), fi(), !(t instanceof Uint8Array)) throw ui("Blob.fromUint8Array", "Uint8Array", 1, t);
        return new di(Z.fromUint8Array(t));
    }
    toBase64() {
        return Ks("Blob.toBase64", arguments, 0), this.Nc.toBase64();
    }
    toUint8Array() {
        return Ks("Blob.toUint8Array", arguments, 0), fi(), this.Nc.toUint8Array();
    }
    toString() {
 ...
 */ class wi {
    constructor(t) {
        !function(t, e, n, s) {
            if (!(e instanceof Array) || e.length < s) throw new x(k.INVALID_ARGUMENT, `Function ${t}() requires its ${n} argument to be an array with at least ` + _i(s, "element") + ".");
        }("FieldPath", t, "fieldNames", 1);
        for (let e = 0; e < t.length; ++e) if (Xs("FieldPath", "string", e, t[e]), 0 === t[e].length) throw new x(k.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
        this.$c = new B(t);
    }
}
 ...
 */ class Ti extends wi {
    ...
    isEqual(t) {
        if (!(t instanceof Ti)) throw ui("isEqual", "FieldPath", 1, t);
...
class Pi extends mi {
    ...
    Lc(t) {
        const e = Ri(this, t, 
        /*array=*/ !0), n = this.Bc.map(t => qi(t, e)), s = new Ce(n);
...
class Vi extends mi {
    ...
    Lc(t) {
        const e = Ri(this, t, 
        /*array=*/ !0), n = this.Bc.map(t => qi(t, e)), s = new Fe(n);
        return new Oe(t.path, s);
    }
    isEqual(t) {
        // TODO(mrschmidt): Implement isEquals
...
class pi extends mi {
    ...
    Lc(t) {
        const e = new $e(t.serializer, se(t.serializer, this.Wc));
...
/** The public FieldValue class of the lite API. */ class yi extends mi {
    constructor() {
        super();
    }
    static delete() {
        return zs("FieldValue.delete", arguments), new gi(new Ii("FieldValue.delete"));
    }
    static serverTimestamp() {
        return zs("FieldValue.serverTimestamp", arguments), new gi(new Ai("FieldValue.serverTimestamp"));
    }
    static arrayUnion(...t) {
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we'd need the Firestore instance to do this.
        return Hs("FieldValue.arrayUnion", arguments, 1), new gi(new Pi("FieldValue.arrayUnion", t));
    }
    static arrayRemove(...t) {
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we'd need the Firestore instance to do this.
        return Hs("FieldValue.arrayRemove", arguments, 1), new gi(new Vi("FieldValue.arrayRemove", t));
    }
    static increment(t) {
        return Xs("FieldValue.increment", "number", 1, t), Ks("FieldValue.increment", arguments, 1), 
        new gi(new pi("FieldValue.increment", t));
    }
}
 ...
 */ class gi extends yi {
    ...
    isEqual(t) {
        return t instanceof gi && this.kc.isEqual(t.kc);
    }
}
 ...
 */ class vi {
    constructor(t, e) {
        if (Ks("GeoPoint", arguments, 2), Xs("GeoPoint", "number", 1, t), Xs("GeoPoint", "number", 2, e), 
     ...
     * with an underscore.
     */    T(t) {
        return v(this.Qc, t.Qc) || v(this.jc, t.jc);
    }
}
...
/** The result of parsing document data (e.g. for a setData call). */ class Ci {
    constructor(t, e, n) {
...
/** The result of parsing "update" data (i.e. for an updateData call). */ class Di {
    constructor(t, e, n) {
        this.data = t, this.qe = e, this.fieldTransforms = n;
    }
    Hc(t, e) {
...
/** A "context" object passed around while parsing user data. */ class Ni {
    ...
    qc(t) {
        return ji(t, this.settings.methodName, this.settings.nl || !1, this.path, this.settings.Mc);
    }
    ...
    Zc(t) {
        ...
        if (Fi(this.Oc) && bi.test(t)) throw this.qc('Document fields cannot begin and end with "__"');
    }
}
 ...
 */ class $i {
    constructor(t, e, n) {
        this.s = t, this.ignoreUndefinedProperties = e, this.serializer = n || Us(t);
    }
...
/** Parse document data from a set() call. */ function ki(t, e, n, s, i, r = {}) {
    const o = t.sl(r.merge || r.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , e, n, i);
    Bi("Data must be an object, but it was:", o, s);
    const h = Mi(s, o);
    let a, u;
    if (r.merge) a = new Le(o.qe), u = o.fieldTransforms; else if (r.mergeFields) {
        const t = [];
        for (const s of r.mergeFields) {
            let i;
            if (s instanceof wi) i = s.$c; else {
    ...
    return new Ci(new sn(h), a, u);
}

/** Parse update data from an update() call. */ function xi(t, e, n, s) {
    const i = t.sl(1 /* Update */ , e, n);
    Bi("Data must be an object, but it was:", i, s);
    const r = [], o = new rn;
    F(s, (t, s) => {
        const h = Qi(e, t, n), a = i.tl(h);
        if (s instanceof mi && s.kc instanceof Ii) 
    ...
    const h = new Le(r);
    return new Di(o.ze(), h, i.fieldTransforms);
}

/** Parse update data from a list of field/value arguments. */ function Li(t, e, n, s, i, r) {
    const o = t.sl(1 /* Update */ , e, n), h = [ Wi(e, s, n) ], a = [ i ];
    ...
    for (let t = 0; t < r.length; t += 2) h.push(Wi(e, r[t])), a.push(r[t + 1]);
    const u = [], c = new rn;
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (let t = h.length - 1; t >= 0; --t) if (!Gi(u, h[t])) {
        const e = h[t], n = a[t], s = o.tl(e);
        if (n instanceof mi && n.kc instanceof Ii) 
        // Add it to the field mask, but don't add anything to updateData.
        u.push(e); else {
            const t = qi(n, s);
    ...
    const l = new Le(u);
    return new Di(c.ze(), l, o.fieldTransforms);
}
 ...
 */ function Oi(t, e, n, s = !1) {
    return qi(n, t.sl(s ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function qi(t, e) {
    if (Ui(t)) return Bi("Unsupported field value:", e, t), Mi(t, e);
    if (t instanceof mi) 
 ...
 */
    return function(t, e) {
        ...
        if (!Fi(e.Oc)) throw e.qc(t.xc + "() can only be used with update() and set()");
 ...
 */ (t, e), null;
    ...
    return function(t, e) {
        ...
        throw e.qc("Unsupported field value: " + oi(t));
    }
    /**
...
function Ui(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof L || t instanceof vi || t instanceof di || t instanceof Si || t instanceof mi);
}
 ...
 */ function Wi(t, e, n) {
    if (e instanceof wi) return e.$c;
    if ("string" == typeof e) return Qi(t, e);
    throw ji("Field path arguments must be of type string or FieldPath.", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
}
 ...
 */ function Qi(t, e, n) {
    try {
        return function(t) {
            if (t.search(Ei) >= 0) throw new x(k.INVALID_ARGUMENT, `Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`);
            try {
                return new Ti(...t.split("."));
            } catch (e) {
                throw new x(k.INVALID_ARGUMENT, `Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`);
            }
        }(e).$c;
    } catch (e) {
        throw ji((s = e) instanceof Error ? s.message : s.toString(), t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, n);
    }
    /**
 ...
 */ class zi {
    ...
    async al(t) {
        if (this.ul(), this.mutations.length > 0) throw new x(k.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
        const e = await async function(t, e) {
            const n = p(t), s = _e(n.serializer) + "/documents", i = {
        ...
        return e.forEach(t => {
            t instanceof un || t instanceof an ? this.cl(t) : P();
        }), e;
    }
    set(t, e) {
    ...
    delete(t) {
        this.write([ new en(t, this.Be(t)) ]), this.hl.add(t);
    }
    async commit() {
     ...
     */    Be(t) {
        ...
        return !this.hl.has(t) && e ? Ue.updateTime(e) : Ue.je();
    }
    /**
...
class Ki {
    constructor(t, e, n, s) {
        this.Vs = t, this.xo = e, this.updateFunction = n, this.gs = s, this._l = 5, this.Os = new Gn(this.Vs, "transaction_retry" /* TransactionRetry */);
    }
    ...
    fl() {
        this.Os.fs(async () => {
            const t = new zi(this.xo), e = this.dl(t);
            e && e.then(e => {
    ...
    dl(t) {
        try {
            ...
            return !Q(e) && e.catch && e.then ? e : (this.gs.reject(Error("Transaction callback must return a Promise")), 
            null);
        } catch (t) {
...
class Hi {
     ...
     */    start(t, e, n, s) {
        ...
        return this.credentials.kr(t => {
            if (!r) return r = !0, m("FirestoreClient", "Initializing. user=", t.uid), this.Il(e, n, s, t, i).then(this.El.resolve, this.El.reject);
     ...
     */    ml() {
        if (this.Vs.Ms) throw new x(k.FAILED_PRECONDITION, "The client has already been terminated.");
    }
    ...
    listen(t, e, n) {
        this.ml();
        const s = new Gs(n), i = new bs(t, s, e);
 ...
 */ (this.Vs, this.ko, t);
    ...
    async Vl(t, e) {
        return this.ml(), await this.El.promise, function(t, e, n, s) {
            const i = new jn, r = Yi(t, e, fn(n.path), {
        ...
        return this.ml(), await this.El.promise, async function(t, e, n) {
            ...
            return await t.enqueue(async () => {
                try {
                    ...
                    /* usePreviousResults= */ !0), i = new Ps(n, t._r), r = i.Kh(t.documents), o = i.Jh(r, 
                    /* updateLimboDocuments= */ !1);
 ...
 */ (this.Vs, this.Rl, t, e);
     ...
     */    transaction(t) {
        this.ml();
        const e = new jn;
        return this.Vs.Cs(() => (new Ki(this.Vs, this.xo, t, e).run(), Promise.resolve())), 
        e.promise;
    }
}

function Yi(t, e, n, s, i) {
    const r = new Gs(i), o = new bs(n, r, s);
...
class Xi {
    ...
    Nl(t) {
        return new vi(Qt(t.latitude), Qt(t.longitude));
    }
    $l(t) {
...
class Zi {
    constructor(t) {
        ...
        } else Zs("settings", "non-empty string", "host", t.host), this.host = t.host, ti("settings", "boolean", "ssl", t.ssl), 
        this.ssl = null === (e = t.ssl) || void 0 === e || e;
        if (ai("settings", t, [ "host", "ssl", "credentials", "timestampsInSnapshots", "cacheSizeBytes", "experimentalForceLongPolling", "ignoreUndefinedProperties" ]), 
        ti("settings", "object", "credentials", t.credentials), this.credentials = t.credentials, 
        ti("settings", "boolean", "timestampsInSnapshots", t.timestampsInSnapshots), ti("settings", "boolean", "ignoreUndefinedProperties", t.ignoreUndefinedProperties), 
        ...
        ti("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = es.ai; else {
            if (t.cacheSizeBytes !== Ji && t.cacheSizeBytes < es.hi) throw new x(k.INVALID_ARGUMENT, "cacheSizeBytes must be at least " + es.hi);
            this.cacheSizeBytes = t.cacheSizeBytes;
        }
        ti("settings", "boolean", "experimentalForceLongPolling", t.experimentalForceLongPolling), 
 ...
 */ class tr {
    ...
    constructor(t, e, n = new Ws, s = new Qs) {
        if (this.xl = n, this.Ll = s, this.Ol = null, 
        // Public for use in tests.
        // TODO(mikelehen): Use modularized initialization instead.
        this.ql = new Zn, this.INTERNAL = {
            delete: async () => {
            ...
            const n = t;
            this.Ol = n, this.Gc = tr.Bl(n), this.Wl = n.name, this.Ql = new us(e);
        } else {
            const e = t;
            if (!e.projectId) throw new x(k.INVALID_ARGUMENT, "Must provide projectId");
            this.Gc = new C(e.projectId, e.database), 
            // Use a default persistenceKey that lines up with FirebaseApp.
            this.Wl = "[DEFAULT]", this.Ql = new as;
        }
        this.jl = new Zi({});
    }
    get Gl() {
        ...
        this.zl = new $i(this.Gc, this.jl.ignoreUndefinedProperties)), this.zl;
    }
    settings(t) {
        Ks("Firestore.settings", arguments, 1), Xs("Firestore.settings", "object", 1, t);
        const e = new Zi(t);
 ...
 */ (e.credentials));
    ...
    onSnapshotsInSync(t) {
        if (this.Ml(), js(t)) return this.Ul.Qa(t);
        {
            Xs("Firestore.onSnapshotsInSync", "function", 1, t);
            const e = {
                next: t
            };
            return this.Ul.Qa(e);
    ...
    Ml() {
        ...
        // eslint-disable-next-line @typescript-eslint/no-floating-promises
        this.Hl(new Ws, new Qs, {
            Vc: !1
        }), this.Ul;
    }
    Jl() {
        return new S(this.Gc, this.Wl, this.jl.host, this.jl.ssl, this.jl.forceLongPolling);
    }
    Hl(t, e, n) {
        const s = this.Jl();
        return this.Ul = new Hi(this.Ql, this.ql), this.Ul.start(s, t, e, n);
    }
    static Bl(t) {
 ...
 */        const s = t.options.projectId;
    ...
    collection(t) {
        return Ks("Firestore.collection", arguments, 1), Xs("Firestore.collection", "non-empty string", 1, t), 
        this.Ml(), new wr(M.$(t), this, 
        /* converter= */ null);
    }
    doc(t) {
        return Ks("Firestore.doc", arguments, 1), Xs("Firestore.doc", "non-empty string", 1, t), 
        this.Ml(), sr.Zl(M.$(t), this, 
        /* converter= */ null);
    }
    collectionGroup(t) {
        if (Ks("Firestore.collectionGroup", arguments, 1), Xs("Firestore.collectionGroup", "non-empty string", 1, t), 
        ...
        return this.Ml(), new fr(function(t) {
            return new _n(M.k(), t);
        }(t), this, 
        /* converter= */ null);
    }
    runTransaction(t) {
        return Ks("Firestore.runTransaction", arguments, 1), Xs("Firestore.runTransaction", "function", 1, t), 
        this.Ml().transaction(e => t(new er(this, e)));
    }
    batch() {
        return this.Ml(), new nr(this);
    }
    static get logLevel() {
        switch (E()) {
          case n.DEBUG:
    ...
    static setLogLevel(t) {
        var e;
        Ks("Firestore.setLogLevel", arguments, 1), si("setLogLevel", [ "debug", "error", "silent", "warn", "info", "verbose" ], 1, t), 
        e = t, T.setLogLevel(e);
    }
 ...
 */ class er {
    ...
    get(t) {
        Ks("Transaction.get", arguments, 1);
        const e = Ir("Transaction.get", t, this.e_);
        return this.n_.al([ e.zc ]).then(t => {
            if (!t || 1 !== t.length) return P();
            const n = t[0];
            if (n instanceof un) return new rr(this.e_, e.zc, null, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, e.Kc);
            if (n instanceof an) return new rr(this.e_, e.zc, n, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, e.Kc);
            throw P();
        });
    ...
    set(t, e, n) {
        Ys("Transaction.set", arguments, 2, 3);
        const s = Ir("Transaction.set", t, this.e_);
        n = Tr("Transaction.set", n);
        const i = Ar(s.Kc, e, n), r = ki(this.e_.Gl, "Transaction.set", s.zc, i, null !== s.Kc, n);
        return this.n_.set(s.zc, r), this;
    }
    update(t, e, n, ...s) {
        let i, r;
        return "string" == typeof e || e instanceof Ti ? (Hs("Transaction.update", arguments, 3), 
        i = Ir("Transaction.update", t, this.e_), r = Li(this.e_.Gl, "Transaction.update", i.zc, e, n, s)) : (Ks("Transaction.update", arguments, 2), 
        i = Ir("Transaction.update", t, this.e_), r = xi(this.e_.Gl, "Transaction.update", i.zc, e)), 
        this.n_.update(i.zc, r), this;
    }
    delete(t) {
        Ks("Transaction.delete", arguments, 1);
        const e = Ir("Transaction.delete", t, this.e_);
...
class nr {
    ...
    set(t, e, n) {
        Ys("WriteBatch.set", arguments, 2, 3), this.r_();
        const s = Ir("WriteBatch.set", t, this.e_);
        n = Tr("WriteBatch.set", n);
        const i = Ar(s.Kc, e, n), r = ki(this.e_.Gl, "WriteBatch.set", s.zc, i, null !== s.Kc, n);
        return this.s_ = this.s_.concat(r.Hc(s.zc, Ue.je())), this;
    }
    update(t, e, n, ...s) {
        let i, r;
        return this.r_(), "string" == typeof e || e instanceof Ti ? (Hs("WriteBatch.update", arguments, 3), 
        i = Ir("WriteBatch.update", t, this.e_), r = Li(this.e_.Gl, "WriteBatch.update", i.zc, e, n, s)) : (Ks("WriteBatch.update", arguments, 2), 
        i = Ir("WriteBatch.update", t, this.e_), r = xi(this.e_.Gl, "WriteBatch.update", i.zc, e)), 
        this.s_ = this.s_.concat(r.Hc(i.zc, Ue.exists(!0))), this;
    }
    delete(t) {
        Ks("WriteBatch.delete", arguments, 1), this.r_();
        const e = Ir("WriteBatch.delete", t, this.e_);
        return this.s_ = this.s_.concat(new en(e.zc, Ue.je())), this;
    }
    commit() {
 ...
 */ class sr extends Si {
    ...
    static Zl(t, e, n) {
        ...
        return new sr(new W(t), e, n);
    }
    get id() {
        return this.zc.path.S();
    }
    get parent() {
        return new wr(this.zc.path.g(), this.firestore, this.Kc);
    }
    get path() {
        return this.zc.path.N();
    }
    collection(t) {
        if (Ks("DocumentReference.collection", arguments, 1), Xs("DocumentReference.collection", "non-empty string", 1, t), 
        !t) throw new x(k.INVALID_ARGUMENT, "Must provide a non-empty collection name to collection()");
        const e = M.$(t);
        return new wr(this.zc.path.child(e), this.firestore, 
        /* converter= */ null);
    }
    isEqual(t) {
        if (!(t instanceof sr)) throw ui("isEqual", "DocumentReference", 1, t);
        return this.firestore === t.firestore && this.zc.isEqual(t.zc) && this.Kc === t.Kc;
    }
    set(t, e) {
        Ys("DocumentReference.set", arguments, 1, 2), e = Tr("DocumentReference.set", e);
        const n = Ar(this.Kc, t, e), s = ki(this.firestore.Gl, "DocumentReference.set", this.zc, n, null !== this.Kc, e);
        return this.Ul.write(s.Hc(this.zc, Ue.je()));
    }
    update(t, e, ...n) {
        let s;
        return "string" == typeof t || t instanceof Ti ? (Hs("DocumentReference.update", arguments, 2), 
        s = Li(this.firestore.Gl, "DocumentReference.update", this.zc, t, e, n)) : (Ks("DocumentReference.update", arguments, 1), 
        s = xi(this.firestore.Gl, "DocumentReference.update", this.zc, t)), this.Ul.write(s.Hc(this.zc, Ue.exists(!0)));
    }
    delete() {
        return Ks("DocumentReference.delete", arguments, 0), this.Ul.write([ new en(this.zc, Ue.je()) ]);
    }
    onSnapshot(...t) {
        var e, n, s;
        Ys("DocumentReference.onSnapshot", arguments, 1, 4);
        let i = {
            includeMetadataChanges: !1
        }, r = 0;
        "object" != typeof t[r] || js(t[r]) || (i = t[r], ai("DocumentReference.onSnapshot", i, [ "includeMetadataChanges" ]), 
        ti("DocumentReference.onSnapshot", "boolean", "includeMetadataChanges", i.includeMetadataChanges), 
        r++);
        const o = {
        ...
        } else Xs("DocumentReference.onSnapshot", "function", r, t[r]), Js("DocumentReference.onSnapshot", "function", r + 1, t[r + 1]), 
        Js("DocumentReference.onSnapshot", "function", r + 2, t[r + 2]);
        const h = {
            next: e => {
                t[r] && t[r](this.o_(e));
            },
        ...
        return this.Ul.listen(fn(this.zc.path), o, h);
    }
    get(t) {
        Ys("DocumentReference.get", arguments, 0, 1), mr("DocumentReference.get", t);
        const e = this.firestore.Ml();
        return t && "cache" === t.source ? e.Pl(this.zc).then(t => new rr(this.firestore, this.zc, t, 
        /*fromCache=*/ !0, t instanceof an && t.Ge, this.Kc)) : e.Vl(this.zc, t).then(t => this.o_(t));
    }
    withConverter(t) {
        return new sr(this.zc, this.firestore, t);
    }
    /**
     ...
     */    o_(t) {
        ...
        return new rr(this.firestore, this.zc, e, t.fromCache, t.hasPendingWrites, this.Kc);
    }
}
...
class rr {
    ...
    data(t) {
        if (Ys("DocumentSnapshot.data", arguments, 0, 1), t = Er("DocumentSnapshot.data", t), 
        this.h_) {
            // We only want to use the converter and create a new DocumentSnapshot
            // if a converter has been provided.
            if (this.Kc) {
                const e = new or(this.e_, this.zc, this.h_, this.a_, this.u_, 
                /* converter= */ null);
                return this.Kc.fromFirestore(e, t);
            }
            return new Xi(this.e_.Gc, this.e_.t_(), t.serverTimestamps || "none", t => new sr(t, this.e_, /* converter= */ null)).Sl(this.h_.Ze());
        }
    }
    get(t, e) {
        if (Ys("DocumentSnapshot.get", arguments, 1, 2), e = Er("DocumentSnapshot.get", e), 
        this.h_) {
            const n = this.h_.data().field(Wi("DocumentSnapshot.get", t, this.zc));
            if (null !== n) {
                return new Xi(this.e_.Gc, this.e_.t_(), e.serverTimestamps || "none", t => new sr(t, this.e_, this.Kc)).Sl(n);
            }
        }
    }
    get id() {
    ...
    get ref() {
        return new sr(this.zc, this.e_, this.Kc);
    }
    get exists() {
        return null !== this.h_;
    }
    get metadata() {
        return new ir(this.u_, this.a_);
    }
    isEqual(t) {
        if (!(t instanceof rr)) throw ui("isEqual", "DocumentSnapshot", 1, t);
...
function hr(t, e, n, s, i, r, o) {
    ...
    if (i.O()) {
        ...
        if ("in" /* IN */ === r) {
            cr(o, r);
            const e = [];
            for (const n of o) e.push(ur(s, t, n));
            h = {
                arrayValue: {
                    values: e
                }
    ...
    } else "in" /* IN */ !== r && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== r || cr(o, r), 
    h = Oi(n, e, o, "in" /* IN */ === r);
    const a = yn.create(i, r, h);
    return function(t, e) {
        ...
        if (e.ln()) {
            ...
            throw o === e.op ? new x(k.INVALID_ARGUMENT, `Invalid query. You cannot use more than one '${e.op.toString()}' filter.`) : new x(k.INVALID_ARGUMENT, `Invalid query. You cannot use '${e.op.toString()}' filters with '${o.toString()}' filters.`);
        }
    }(t, a), a;
}
...
function ur(t, e, n) {
    ...
    if (n instanceof Si) return Gt(t, n.zc);
    throw new x(k.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + oi(n) + ".");
}
...
class fr {
    ...
    where(t, e, n) {
        Ks("Query.where", arguments, 3), hi("Query.where", 3, n);
        // Enumerated from the WhereFilterOp type in index.d.ts.
        const s = si("Query.where", [ "<" /* LESS_THAN */ , "<=" /* LESS_THAN_OR_EQUAL */ , "==" /* EQUAL */ , ">=" /* GREATER_THAN_OR_EQUAL */ , ">" /* GREATER_THAN */ , "array-contains" /* ARRAY_CONTAINS */ , "in" /* IN */ , "array-contains-any" /* ARRAY_CONTAINS_ANY */ ], 2, e), i = Wi("Query.where", t), r = hr(this.c_, "Query.where", this.firestore.Gl, this.firestore.Gc, i, s, n);
    ...
    orderBy(t, e) {
        let n;
        if (Ys("Query.orderBy", arguments, 1, 2), Js("Query.orderBy", "non-empty string", 2, e), 
        ...
        const s = Wi("Query.orderBy", t), i = ar(this.c_, s, n);
        return new fr(function(t, e) {
    ...
    limit(t) {
        return Ks("Query.limit", arguments, 1), Xs("Query.limit", "number", 1, t), ci("Query.limit", 1, t), 
        new fr(En(this.c_, t, "F" /* First */), this.firestore, this.Kc);
    }
    limitToLast(t) {
        return Ks("Query.limitToLast", arguments, 1), Xs("Query.limitToLast", "number", 1, t), 
        ci("Query.limitToLast", 1, t), new fr(En(this.c_, t, "L" /* Last */), this.firestore, this.Kc);
    }
    startAt(t, ...e) {
        Hs("Query.startAt", arguments, 1);
        const n = this.l_("Query.startAt", t, e, 
        /*before=*/ !0);
        return new fr(mn(this.c_, n), this.firestore, this.Kc);
    }
    startAfter(t, ...e) {
        Hs("Query.startAfter", arguments, 1);
        const n = this.l_("Query.startAfter", t, e, 
        /*before=*/ !1);
        return new fr(mn(this.c_, n), this.firestore, this.Kc);
    }
    endBefore(t, ...e) {
        Hs("Query.endBefore", arguments, 1);
        const n = this.l_("Query.endBefore", t, e, 
        /*before=*/ !0);
        return new fr(In(this.c_, n), this.firestore, this.Kc);
    }
    endAt(t, ...e) {
        Hs("Query.endAt", arguments, 1);
        const n = this.l_("Query.endAt", t, e, 
        /*before=*/ !1);
        return new fr(In(this.c_, n), this.firestore, this.Kc);
    }
    isEqual(t) {
        if (!(t instanceof fr)) throw ui("isEqual", "Query", 1, t);
        return this.firestore === t.firestore && Rn(this.c_, t.c_) && this.Kc === t.Kc;
    }
    withConverter(t) {
        return new fr(this.c_, this.firestore, t);
    }
    /** Helper function to create a bound from a document or fields */    l_(t, e, n, s) {
        if (hi(t, 1, e), e instanceof rr) return Ks(t, [ e, ...n ], 1), function(t, e, n, s, i) {
 ...
 */ (this.c_, this.firestore.Gc, t, e.h_, s);
    ...
    onSnapshot(...t) {
        var e, n, s;
        Ys("Query.onSnapshot", arguments, 1, 4);
        let i = {}, r = 0;
        if ("object" != typeof t[r] || js(t[r]) || (i = t[r], ai("Query.onSnapshot", i, [ "includeMetadataChanges" ]), 
        ti("Query.onSnapshot", "boolean", "includeMetadataChanges", i.includeMetadataChanges), 
        r++), js(t[r])) {
            const i = t[r];
            t[r] = null === (e = i.next) || void 0 === e ? void 0 : e.bind(i), t[r + 1] = null === (n = i.error) || void 0 === n ? void 0 : n.bind(i), 
            t[r + 2] = null === (s = i.complete) || void 0 === s ? void 0 : s.bind(i);
        } else Xs("Query.onSnapshot", "function", r, t[r]), Js("Query.onSnapshot", "function", r + 1, t[r + 1]), 
        Js("Query.onSnapshot", "function", r + 2, t[r + 2]);
        const o = {
            next: e => {
                t[r] && t[r](new dr(this.firestore, this.c_, e, this.Kc));
            },
            error: t[r + 1],
            complete: t[r + 2]
        };
    ...
    get(t) {
        Ys("Query.get", arguments, 0, 1), mr("Query.get", t), _r(this.c_);
        const e = this.firestore.Ml();
        return (t && "cache" === t.source ? e.pl(this.c_) : e.yl(this.c_, t)).then(t => new dr(this.firestore, this.c_, t, this.Kc));
    }
}
...
class dr {
    constructor(t, e, n, s) {
        ...
        this.metadata = new ir(n.hasPendingWrites, n.fromCache);
    }
    get docs() {
        const t = [];
    ...
    forEach(t, e) {
        Ys("QuerySnapshot.forEach", arguments, 1, 2), Xs("QuerySnapshot.forEach", "function", 1, t), 
        this.f_.docs.forEach(n => {
            t.call(e, this.T_(n, this.metadata.fromCache, this.f_.qt.has(n.key)));
        });
    }
    get query() {
        return new fr(this.__, this.e_, this.Kc);
    }
    docChanges(t) {
        t && (ai("QuerySnapshot.docChanges", t, [ "includeMetadataChanges" ]), ti("QuerySnapshot.docChanges", "boolean", "includeMetadataChanges", t.includeMetadataChanges));
 ...
 */
    ...
    /** Check the equality. The call can be very expensive. */    isEqual(t) {
        if (!(t instanceof dr)) throw ui("isEqual", "QuerySnapshot", 1, t);
        return this.e_ === t.e_ && Rn(this.__, t.__) && this.f_.isEqual(t.f_) && this.Kc === t.Kc;
    }
    T_(t, e, n) {
        return new or(this.e_, t.key, t, e, n, this.Kc);
    }
}

class wr extends fr {
    constructor(t, e, n) {
        if (super(fn(t), e, n), this.E_ = t, t.length % 2 != 1) throw new x(k.INVALID_ARGUMENT, `Invalid collection reference. Collection references must have an odd number of segments, but ${t.N()} has ${t.length}`);
    }
    get id() {
    ...
    get parent() {
        ...
        return t._() ? null : new sr(new W(t), this.firestore, 
        /* converter= */ null);
    }
    get path() {
    ...
    doc(t) {
        Ys("CollectionReference.doc", arguments, 0, 1), 
        // We allow omission of 'pathString' but explicitly prohibit passing in both
        // 'undefined' and 'null'.
        0 === arguments.length && (t = g.t()), Xs("CollectionReference.doc", "non-empty string", 1, t);
        const e = M.$(t);
        return sr.Zl(this.c_.path.child(e), this.firestore, this.Kc);
    }
    add(t) {
        Ks("CollectionReference.add", arguments, 1);
        Xs("CollectionReference.add", "object", 1, this.Kc ? this.Kc.toFirestore(t) : t);
        const e = this.doc();
        return e.set(t).then(() => e);
    }
    withConverter(t) {
        return new wr(this.E_, this.firestore, t);
    }
}
...
function Tr(t, e) {
    ...
    if (ai(t, e, [ "merge", "mergeFields" ]), ti(t, "boolean", "merge", e.merge), ei(t, "mergeFields", "a string or a FieldPath", e.mergeFields, t => "string" == typeof t || t instanceof Ti), 
...
function Er(t, e) {
    return void 0 === e ? {} : (ai(t, e, [ "serverTimestamps" ]), ni(t, 0, "serverTimestamps", e.serverTimestamps, [ "estimate", "previous", "none" ]), 
    e);
}

function mr(t, e) {
    Js(t, "object", 1, e), e && (ai(t, e, [ "source" ]), ni(t, 0, "source", e.source, [ "default", "server", "cache" ]));
}
...
function Ir(t, e, n) {
    ...
    throw ui(t, "DocumentReference", 1, e);
}
...
const Pr = {
    ...
    Transaction: er,
    WriteBatch: nr,
    DocumentReference: sr,
    DocumentSnapshot: rr,
    Query: fr,
    QueryDocumentSnapshot: or,
    QuerySnapshot: dr,
    CollectionReference: wr,
    FieldPath: Ti,
    FieldValue: yi,
    setLogLevel: tr.setLogLevel,
...
function Vr(t) {
    ...
    }(t, (t, e) => new tr(t, e, new Ws, new Qs)), t.registerVersion("@firebase/firestore", "1.16.3", "rn");
}
