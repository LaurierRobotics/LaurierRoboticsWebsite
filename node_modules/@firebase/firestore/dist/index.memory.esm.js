...
function(t, e, n, r, i) {
    ...
    return Object.defineProperty(t.prototype, "i", {
        ...
        return R(this.projectId, t.projectId) || R(this.database, t.database);
    }, t;
}();
 ...
 */ var C = /** @class */ function() {
    ...
    function t(t, e) {
        if (this.seconds = t, this.nanoseconds = e, e < 0) throw new F(M.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (e >= 1e9) throw new F(M.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (t < -62135596800) throw new F(M.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
        // This will break in the year 10,000.
                if (t >= 253402300800) throw new F(M.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
    }
    ...
    n.$ = function(t) {
        ...
        // sequences (e.g. __id123__) and just passes them through raw (they exist
        // for legacy reasons and should not be used frequently).
        if (t.indexOf("//") >= 0) throw new F(M.INVALID_ARGUMENT, "Invalid path (" + t + "). Paths must not contain // in them.");
...
}(j), B = /^[_a-zA-Z][_a-zA-Z0-9]*$/, K = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return t(n, e), n.prototype.V = function(t, e, r) {
    ...
    n.M = function(t) {
        for (var e = [], r = "", i = 0, o = function() {
            if (0 === r.length) throw new F(M.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            e.push(r), r = "";
        }, s = !1; i < t.length; ) {
            var u = t[i];
            if ("\\" === u) {
                if (i + 1 === t.length) throw new F(M.INVALID_ARGUMENT, "Path has trailing escape character: " + t);
                var a = t[i + 1];
                if ("\\" !== a && "." !== a && "`" !== a) throw new F(M.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t);
                r += a, i += 2;
            } else "`" === u ? (s = !s, i++) : "." !== u || s ? (r += u, i++) : (o(), i++);
        }
        if (o(), s) throw new F(M.INVALID_ARGUMENT, "Unterminated ` in path: " + t);
        return new n(e);
    }, n.k = function() {
        return new n([]);
    }, n;
...
function X(t) {
    ...
    if (null === e.G) {
        ...
        null !== e.collectionGroup && (n += "|cg:" + e.collectionGroup), n += "|f:", n += e.filters.map((function(t) {
            ...
            var e;
        })).join(","), Q(e.limit) || (n += "|l:", n += e.limit), e.startAt && (n += "|lb:", 
...
var et, nt, rt = /** @class */ function() {
     ...
     */ , s) {
        void 0 === i && (i = G.min()), void 0 === o && (o = G.min()), void 0 === s && (s = tt.Y), 
 ...
 */ function st(t) {
    ...
    return I("GRPC error has no .code"), M.UNKNOWN;
    switch (t) {
      case et.OK:
        return M.OK;
...
var gt = new ut(W.P), mt = new ht(W.P);
 ...
 */ var It = /** @class */ function() {
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, _t.Kt(e, n)), new t(G.min(), r, Et(), pt(), wt());
    }, t;
}(), _t = /** @class */ function() {
    function t(
    /**
...
/** An RPC error indicating why the watch failed. */ , r) {
    ...
    t.prototype.Ne = function(t) {
        ...
        return this.Ie = pt(), this.Re = Pt(), this.Ae = new ht(R), i;
    }, 
    /**
    ...
    t.prototype.de = function(t) {
        ...
        var e = this.Re.get(t);
        return e || (e = new ht(R), this.Re = this.Re.nt(t, e)), e;
    }, 
    /**
...
/** Tests `left` and `right` for equality based on the backend semantics. */ function Mt(t, e) {
    ...
    switch (n) {
      ...
      case 9 /* ArrayValue */ :
        return O(t.arrayValue.values || [], e.arrayValue.values || [], Mt);
...
function xt(t, e) {
    ...
    switch (n) {
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            var n = R(Bt(t.latitude), Bt(e.latitude));
            return 0 !== n ? n : R(Bt(t.longitude), Bt(e.longitude));
...
function Gt(t, e) {
    ...
    var n = zt(t), r = zt(e), i = R(n.seconds, r.seconds);
...
function jt(t) {
    return function t(e) {
        ...
        W.U(r).toString()) : "geoPointValue" in e ? "geo(" + (n = e.geoPointValue).latitude + "," + n.longitude + ")" : "arrayValue" in e ? function(e) {
 ...
 */ function xe(t, e, n, r) {
    return t instanceof Be ? function(t, e) {
        ...
        return Ce(t.Be, e) ? new rn(t.key, G.min()) : e;
    }(t, e);
}
...
function je(t, e) {
    return t.type === e.type && !!t.key.isEqual(e.key) && !!t.Be.isEqual(e.Be) && (0 /* Set */ === t.type ? t.value.isEqual(e.value) : 1 /* Patch */ === t.type ? t.data.isEqual(e.data) && t.qe.isEqual(e.qe) : 2 /* Transform */ !== t.type || O(t.fieldTransforms, t.fieldTransforms, (function(t, e) {
        return function(t, e) {
            return t.field.isEqual(e.field) && function(t, e) {
                return t instanceof _e && e instanceof _e || t instanceof Ve && e instanceof Ve ? O(t.elements, e.elements, Mt) : t instanceof Re && e instanceof Re ? Mt(t.Me, e.Me) : t instanceof Te && e instanceof Te;
 ...
 */ function ze(t) {
    return t instanceof nn ? t.version : G.min();
}
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
e) {
    if (!(t instanceof e)) throw e.name === t.constructor.name ? new F(M.INVALID_ARGUMENT, "Type does not match the expected instance. Did you pass '" + e.name + "' from a different Firestore SDK?") : new F(M.INVALID_ARGUMENT, "Expected type '" + e.name + "', but was '" + t.constructor.name + "'");
    return t;
}
 ...
 */ function hn(t) {
    ...
    if (null === e.nn) {
        ...
        n.O() || e.nn.push(new Rn(n)), e.nn.push(new Rn(K.q(), "asc" /* ASCENDING */)); else {
...
function gn(t) {
    return "Query(target=" + function(t) {
        ...
        Q(t.limit) || (e += ", limit: " + t.limit), t.orderBy.length > 0 && (e += ", orderBy: [" + t.orderBy.map((function(t) {
            return (e = t).field.N() + " (" + e.dir + ")";
            var e;
...
var bn = /** @class */ function(e) {
     ...
     */    return t(n, e), n.create = function(t, e, r) {
        ...
        if (Ht(r)) {
            if ("==" /* EQUAL */ !== e) throw new F(M.INVALID_ARGUMENT, "Invalid query. Null supports only equality comparisons.");
            return new n(t, e, r);
        }
        if ($t(r)) {
            if ("==" /* EQUAL */ !== e) throw new F(M.INVALID_ARGUMENT, "Invalid query. NaN supports only equality comparisons.");
            return new n(t, e, r);
        }
...
var En = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this, t, n, r) || this).key = W.U(r.referenceValue), i;
    }
 ...
 */ function Vn(t, e, n) {
    for (var r = 0, i = 0; i < t.position.length; i++) {
        ...
        if (r = o.field.O() ? W.P(W.U(s.referenceValue), n.key) : xt(s, n.field(o.field)), 
...
function On(t, e, n) {
    var r = t.field.O() ? W.P(e.key, n.key) : function(t, e, n) {
        var r = e.field(t), i = n.field(t);
        return null !== r && null !== i ? xt(r, i) : T();
    }(t.field, e, n);
    switch (t.dir) {
      case "asc" /* ASCENDING */ :
        return r;
 ...
 */ var Ln = /** @class */ function() {
    ...
    return t.prototype.catch = function(t) {
        ...
        var r = this;
        return this.pn && T(), this.pn = !0, this.Vn ? this.error ? this.yn(n, this.error) : this.gn(e, this.result) : new t((function(t, i) {
            r.An = function(n) {
                r.gn(e, n).next(t, i);
            }, r.Pn = function(e) {
                r.yn(n, e).next(t, i);
 ...
 */
        ...
        return this.$n(t, new W(e)).next((function(t) {
            var e = vt();
...
var Fn = function() {
    ...
    t.prototype.fs = function(t) {
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                i > 0 && E("ExponentialBackoff", "Backing off for " + i + " ms (base delay: " + this.us + " ms, delay with jitter: " + n + " ms, last attempt: " + r + " ms ago)"), 
 ...
 */ var Wn = /** @class */ function() {
    ...
    t.prototype.cancel = function(t) {
        null !== this.bs && (this.clearTimeout(), this.gs.reject(new F(M.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
    ...
    t.prototype.zs = function() {
        ...
        var e = this, n = this.Ds.then((function() {
            return e.xs = !0, t().catch((function(t) {
                ...
                throw e.ks = t, e.xs = !1, I("INTERNAL UNHANDLED ERROR: ", 
                /**
 ...
 */
function Yn(t, e) {
    if (I("AsyncQueue", e + ": " + t), Bn(t)) return new F(M.UNAVAILABLE, e + ": " + t);
    throw t;
}
...
var $n = /** @class */ function() {
    ...
    t, e, n) {
        ...
        /**
             ...
             */
        this.di = G.min(), this.Fn = t.wi(n), this.Ti = t.mi(), this.Ei = t.Ii(), this.Ri = new qn(this.Ti, this.Fn, this.persistence.Ai()), 
        this.li.Pi(this.Ri);
    }
        ...
        return this.persistence.runTransaction("Apply remote event", "readwrite-primary", (function(o) {
            ...
            u.push(s.getEntries(o, c).next((function(t) {
                e.jt.forEach((function(i, c) {
                    ...
                    // cache.
                                        c instanceof rn && c.version.isEqual(G.min()) ? (
    ...
    t.ji = function(t, e, n) {
        ...
        return this.persistence.runTransaction("Execute query", "readonly", (function(o) {
            return n.or(o, fn(t)).next((function(t) {
                ...
                return n.li.Bn(o, t, e ? r : G.min(), e ? i : wt());
            })).next((function(t) {
                return {
                    documents: t,
                    _r: i
 ...
 */ function Xn(t) {
    return e(this, void 0, void 0, (function() {
        return n(this, (function(e) {
            if (t.code !== M.FAILED_PRECONDITION || "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab." !== t.message) throw t;
...
var Jn = /** @class */ function() {
    ...
    t.prototype.Vr = function(t) {
        var e = this, n = new W(new z([])), r = new Zn(n, t), i = new Zn(n, t + 1), o = [];
        ...
        var e = new W(new z([])), n = new Zn(e, t), r = new Zn(e, t + 1), i = wt();
    ...
    return t.mr = function(t, e) {
        return W.P(t.key, e.key) || R(t.vr, e.vr);
    }, 
    /** Compare by ID then by key */ t.Ir = function(t, e) {
        return R(t.vr, e.vr) || W.P(t.key, e.key);
    }, t;
}(), tr = /** @class */ function() {
    function t(t) {
        this.uid = t;
...
var er = function(t, e) {
    ...
    return t.prototype.getToken = function() {
        ...
        // request is outstanding.
            ...
            return t.qr !== e ? (E("FirebaseCredentialsProvider", "getToken aborted due to token change."), 
    ...
    t.prototype.so = function() {}, t.prototype.auth = function() {
        ...
        // TODO(mikelehen): Just use dispatchIfNotClosed, but see TODO below.
            ...
            e((function() {
                var e = new F(M.UNKNOWN, "Fetching auth token failed: " + n.message);
                return t.ho(e);
            }));
        }));
    ...
    t.prototype.ro = function(t) {
        ...
        return function(n) {
            e.ss.Cs((function() {
                return e.zr === t ? n() : (E("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
                Promise.resolve());
            }));
        };
    }, t;
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                var r = function(t) {
                    ...
                    var e = void 0 === t.code ? M.UNKNOWN : st(t.code);
                ...
                y.document;
                var v = he(t, y.document), g = y.readTime ? ue(y.readTime) : G.min(), m = new rn(v, g), w = y.removedTargetIds || [];
                n = new Dt([], w, m.key, m);
            ...
            return e.targetIds && e.targetIds.length ? G.min() : e.readTime ? ue(e.readTime) : G.min();
        }(t);
    ...
    return t(i, r), i.prototype.Ao = function() {
        if (this.Ro) throw new F(M.FAILED_PRECONDITION, "The client has already been terminated.");
    ...
    /** Gets an auth token and invokes the provided RPC. */ i.prototype.Po = function(t, e, n) {
        ...
        return this.Ao(), this.credentials.getToken().then((function(i) {
            ...
            throw t.code === M.UNAUTHENTICATED && r.credentials.$r(), t;
        }));
    }, 
    ...
    t.prototype.set = function(t) {
        ...
        this.So ? (I(e), this.So = !1) : E("OnlineStateTracker", e);
            ...
            i.Cs((function() {
                return e(u, void 0, void 0, (function() {
                    return n(this, (function(t) {
                        switch (t.label) {
                          case 0:
                            return this.Wo() ? (E("RemoteStore", "Restarting streams for network reachability change."), 
        ...
        return e(this, void 0, void 0, (function() {
            return n(this, (function(t) {
                switch (t.label) {
                  ...
                  case 2:
                    return t.sent(), this.Lo.length > 0 && (E("RemoteStore", "Stopping write stream with " + this.Lo.length + " pending writes"), 
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 11:
                    return E("RemoteStore", "Failed to raise snapshot:", o = n.sent()), [ 4 /*yield*/ , this.fh(o) ];
    ...
    t.prototype.Eh = function(t) {
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return ot(r = t.code) && r !== M.ABORTED ? (e = this.Lo.shift(), 
...
n) {
    ...
    r, i, o) {
        ...
        this.ca = null, this.la = new C((function(t) {
            return vn(t);
        }), yn), this._a = new Map, 
        /**
    ...
    t.prototype.Va = function(t, r, i) {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    // PORTING NOTE: Multi-tab only.
                    this.aa.kh(t, "rejected", r), e = this.wa.get(t), (i = e && e.key) ? (o = (o = new ut(W.P)).nt(i, new rn(i, G.min())), 
                    s = wt().add(i), u = new Tt(G.min(), 
                    /* targetChanges= */ new Map, 
                    /* targetMismatches= */ new ht(R), o, s), [ 4 /*yield*/ , this.Ui(u) ]) : [ 3 /*break*/ , 2 ];
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    this.ha.Wo() || E("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                    n.label = 1;
    ...
    /** Reject all outstanding callbacks waiting for pending writes to complete. */ t.prototype.Na = function(t) {
        this.Ea.forEach((function(e) {
            e.forEach((function(e) {
                e.reject(new F(M.CANCELLED, t));
            }));
        })), this.Ea.clear();
    }, t.prototype.ga = function(t, e) {
        var n = this.ma[this.currentUser.Sr()];
        n || (n = new ut(R)), n = n.nt(t, e), this.ma[this.currentUser.Sr()] = n;
    }, 
    /**
    ...
    t.prototype.Ca = function(t, e) {
        ...
        for (var n = 0, r = e; n < r.length; n++) {
            var i = r[n];
            i instanceof dr ? (this.Ta.tr(i.key, t), this.xa(i)) : i instanceof yr ? (E("SyncEngine", "Document no longer in limbo: " + i.key), 
        ...
        var e = t.key;
        this.da.get(e) || (E("SyncEngine", "New document in limbo: " + e), this.fa.push(e), 
        this.Sa());
    }, 
    /**
    ...
    function t(t) {
        this.lh = t, this.Ma = new C((function(t) {
            return vn(t);
    ...
    return t.prototype.Pi = function(t) {
        ...
        // collection, rather than to perform individual lookups.
                return e.on() || n.isEqual(G.min()) ? this.tu(t, e) : this.Za.qn(t, r).next((function(o) {
            var u = i.eu(e, o);
            return (e.hn() || e.an()) && i.Xh(e.en, u, r, n) ? i.tu(t, e) : (b() <= s.DEBUG && E("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), gn(e)), 
    ...
    return t.prototype.iu = function(t) {
        ...
        // because it precedes all other segments in an ordered traversal.
                W.W(i) || (i = i.child(""));
        var o = new Zn(new W(i), 0), s = new ht(R);
...
var _r = /** @class */ function() {
    ...
    return t(n, e), n.prototype.uc = function(t, e, n, r) {
            ...
            s.listenOnce(d.COMPLETE, (function() {
                try {
                    switch (s.getLastErrorCode()) {
                      ...
                      case y.TIMEOUT:
                        E("Connection", 'RPC "' + t + '" timed out'), o(new F(M.DEADLINE_EXCEEDED, "Request time out"));
                        break;
                      ...
                      case y.HTTP_ERROR:
                        ...
                        n > 0) {
                            ...
                            if (r && r.status && r.message) {
                                ...
                                o(new F(u, r.message));
                            } else o(new F(M.UNKNOWN, "Server responded with status " + s.getStatus()));
                        } else 
                        // If we received an HTTP_ERROR but there's no status code,
                        // it's most probably a connection issue
                        o(new F(M.UNAVAILABLE, "Connection failed."));
                        break;
        ...
        return m(g.EventType.OPEN, (function() {
            ...
            d || (d = !0, N("Connection", "WebChannel transport errored:", t), y.nc(new F(M.UNAVAILABLE, "The operation could not be completed")));
            ...
            if (!d) {
                ...
                if (i) {
                    ...
                    void 0 === u && (u = M.INTERNAL, a = "Unknown error status: " + o + " with message " + i.message), 
                    // Mark closed so no further events are propagated
                    d = !0, y.nc(new F(u, a)), s.close();
 ...
 */ var qr = "You are using the memory-only build of Firestore. Persistence support is only available via the @firebase/firestore bundle or the firebase-firestore.js build.", Cr = /** @class */ function() {
    ...
    return t.prototype.initialize = function(t) {
        ...
        if (t.pc.Vc) throw new F(M.FAILED_PRECONDITION, qr);
        return new Dr(kr.zu);
        ...
        throw new F(M.FAILED_PRECONDITION, qr);
    }, t;
}(), Mr = /** @class */ function() {
    function t() {}
 ...
 */ function Gr(t, e) {
    if (0 !== e.length) throw new F(M.INVALID_ARGUMENT, "Function " + t + "() does not support arguments, but was called with " + oi(e.length, "argument") + ".");
}
 ...
 */ function jr(t, e, n) {
    if (e.length !== n) throw new F(M.INVALID_ARGUMENT, "Function " + t + "() requires " + oi(n, "argument") + ", but was called with " + oi(e.length, "argument") + ".");
}
 ...
 */ function zr(t, e, n) {
    if (e.length < n) throw new F(M.INVALID_ARGUMENT, "Function " + t + "() requires at least " + oi(n, "argument") + ", but was called with " + oi(e.length, "argument") + ".");
}
 ...
 */ function Br(t, e, n, r) {
    if (e.length < n || e.length > r) throw new F(M.INVALID_ARGUMENT, "Function " + t + "() requires between " + n + " and " + r + " arguments, but was called with " + oi(e.length, "argument") + ".");
}
...
function Hr(t, e, n, r, i) {
    void 0 !== r && function(t, e, n, r, i) {
        ...
        var c = Zr(r);
        throw new F(M.INVALID_ARGUMENT, "Invalid value " + c + " provided to function " + t + '() for option "' + n + '". Acceptable values: ' + o.join(", "));
    }(t, 0, n, r, i);
}
 ...
 */ function $r(t, e, n, r) {
    if (!e.some((function(t) {
        return t === r;
    }))) throw new F(M.INVALID_ARGUMENT, "Invalid value " + Zr(r) + " provided to function " + t + "() for its " + ii(n) + " argument. Acceptable values: " + e.join(", "));
    return r;
}
...
/** Helper to validate the type of a provided input. */ function Xr(t, e, n, r) {
    if (!("object" === e ? Jr(r) : "non-empty string" === e ? "string" == typeof r && "" !== r : typeof r === e)) {
        var i = Zr(r);
        throw new F(M.INVALID_ARGUMENT, "Function " + t + "() requires its " + n + " to be of type " + e + ", but it was: " + i);
    }
}
...
function ti(t, e, n) {
    if (void 0 === n) throw new F(M.INVALID_ARGUMENT, "Function " + t + "() requires a valid " + ii(e) + " argument, but it was undefined.");
}
 ...
 */ function ei(t, e, n) {
    S(e, (function(e, r) {
        if (n.indexOf(e) < 0) throw new F(M.INVALID_ARGUMENT, "Unknown option '" + e + "' passed to function " + t + "(). Available options: " + n.join(", "));
    }));
}
 ...
 */ function ni(t, e, n, r) {
    var i = Zr(r);
    return new F(M.INVALID_ARGUMENT, "Function " + t + "() requires its " + ii(n) + " argument to be a " + e + ", but it was: " + i);
}

function ri(t, e, n) {
    if (n <= 0) throw new F(M.INVALID_ARGUMENT, "Function " + t + "() requires its " + ii(e) + " argument to be a positive number, but it was: " + n + ".");
}
...
/** Helper function to assert Uint8Array is available at runtime. */ function si() {
    if ("undefined" == typeof Uint8Array) throw new F(M.UNIMPLEMENTED, "Uint8Arrays are not available in this environment.");
}

/** Helper function to assert Base64 functions are available at runtime. */ function ui() {
    if ("undefined" == typeof atob) throw new F(M.UNIMPLEMENTED, "Blobs are unavailable in Firestore in this environment.");
}
 ...
 */ var ai = /** @class */ function() {
    ...
    return t.fromBase64String = function(e) {
        ...
        try {
            ...
            throw new F(M.INVALID_ARGUMENT, "Failed to construct Blob from Base64 string: " + e);
        }
    }, t.fromUint8Array = function(e) {
    ...
    !function(t, e, n, r) {
        if (!(e instanceof Array) || e.length < 1) throw new F(M.INVALID_ARGUMENT, "Function FieldPath() requires its fieldNames argument to be an array with at least " + oi(1, "element") + ".");
    }(0, t);
    for (var e = 0; e < t.length; ++e) if (Kr("FieldPath", "string", e, t[e]), 0 === t[e].length) throw new F(M.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
    this.$c = new K(t);
}, hi = /** @class */ function(e) {
    /**
...
var yi = /** @class */ function(e) {
    ...
    function t(t, e) {
        ...
        !isFinite(t) || t < -90 || t > 90) throw new F(M.INVALID_ARGUMENT, "Latitude must be a number between -90 and 90, but was: " + t);
        if (!isFinite(e) || e < -180 || e > 180) throw new F(M.INVALID_ARGUMENT, "Longitude must be a number between -180 and 180, but was: " + e);
        this.Qc = t, this.jc = e;
    }
     ...
     */
    t.prototype.T = function(t) {
        return R(this.Qc, t.Qc) || R(this.jc, t.jc);
    }, t;
...
/** Parse document data from a set() call. */ function ki(t, e, n, r, i, o) {
    ...
    if (o.merge) u = new Le(s.qe), a = s.fieldTransforms; else if (o.mergeFields) {
        for (var h = [], f = 0, l = o.mergeFields; f < l.length; f++) {
            ...
            if (!s.contains(d)) throw new F(M.INVALID_ARGUMENT, "Field '" + d + "' is specified in your field mask but missing from your input data.");
            xi(h, d) || h.push(d);
        }
...
/** Parse update data from a list of field/value arguments. */ function Oi(t, e, n, r, i, o) {
    ...
    if (o.length % 2 != 0) throw new F(M.INVALID_ARGUMENT, "Function " + e + "() needs to be called with an even number of arguments that alternate between field names and values.");
...
function Si(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof x || t instanceof Ei || t instanceof ai || t instanceof Ni || t instanceof li);
}
 ...
 */ function Mi(t, e, n) {
    try {
        return function(t) {
            if (t.search(fi) >= 0) throw new F(M.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not contain '~', '*', '/', '[', or ']'");
            try {
                return new (hi.bind.apply(hi, r([ void 0 ], t.split("."))));
            } catch (e) {
                throw new F(M.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            }
        }(e).$c;
    } catch (e) {
...
function Fi(t, e, n, r, i) {
    ...
    a += ")"), new F(M.INVALID_ARGUMENT, (u += ". ") + t + a);
}
 ...
 */ var Gi = /** @class */ function() {
    ...
    return t.prototype.al = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(o) {
                switch (o.label) {
                  case 0:
                    if (this.ul(), this.mutations.length > 0) throw new F(M.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
                    return [ 4 /*yield*/ , function(t, r) {
                        return e(this, void 0, void 0, (function() {
                            ...
                            return n(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    return e = D(t), i = le(e.serializer) + "/documents", o = {
                  ...
                  case 1:
                    return [ 2 /*return*/ , ((r = o.sent()).forEach((function(t) {
                        t instanceof rn || t instanceof nn ? i.cl(t) : T();
                    })), r) ];
                }
            }));
        }));
        ...
        if (n) {
            ...
            throw new F(M.ABORTED, "Document version changed between two reads.");
    ...
    t.prototype.ll = function(t) {
        ...
        // read time and existence
            ...
            // transaction.
            throw new F(M.INVALID_ARGUMENT, "Can't update a document that doesn't exist.");
     ...
     */
    e) {
        this.credentials = t, this.Vs = e, this.clientId = k.t(), 
    ...
    t.prototype.El = function() {
        if (this.Vs.Ms) throw new F(M.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
                                        ...
                                        return e(s, void 0, void 0, (function() {
                                            ...
                                            return n(this, (function(n) {
                                                switch (n.label) {
                                                  ...
                                                  case 1:
                                                    return (t = n.sent()) instanceof nn ? o.resolve(t) : t instanceof rn ? o.resolve(null) : o.reject(new F(M.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)")), 
                                                    [ 3 /*break*/ , 3 ];
                    ...
                    return [ 2 /*return*/ , (e.sent(), function(t, e, n, r) {
                        var i = new Fn, o = Bi(t, e, n, {
                            ...
                            next: function(t) {
                                // Remove query first before passing event to user to avoid
                                // user actions affecting the now stale query.
                                o(), t.fromCache && r && "server" === r.source ? i.reject(new F(M.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(t);
                            },
                            error: function(t) {
                                return i.reject(t);
                            }
...
var Ki = /** @class */ function() {
    ...
    return t.prototype.Sl = function(t) {
        ...
        var e = zt(t), n = new x(e.seconds, e.nanos);
    ...
    function t(t) {
        var e, n, r, i;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new F(M.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
        ...
        Yr("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = Hn.ai; else {
            if (t.cacheSizeBytes !== Wi && t.cacheSizeBytes < Hn.hi) throw new F(M.INVALID_ARGUMENT, "cacheSizeBytes must be at least " + Hn.hi);
    ...
    function t(r, i, o, s) {
        ...
        this.ql = new Qn, this.INTERNAL = {
            ...
            var c = r;
            if (!c.projectId) throw new F(M.INVALID_ARGUMENT, "Must provide projectId");
            this.Gc = new L(c.projectId, c.database), 
    ...
    return Object.defineProperty(t.prototype, "Gl", {
        ...
        var e = new Qi(t);
        if (this.Ul && !this.jl.isEqual(e)) throw new F(M.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only call settings() before calling any other methods on a Firestore object.");
        this.jl = e, void 0 !== e.credentials && (this.Ql = function(t) {
            ...
            switch (t.type) {
              ...
              default:
                throw new F(M.INVALID_ARGUMENT, "makeCredentialsProvider failed due to invalid credential type");
            }
        }(e.credentials));
        ...
        var e, n;
        if (this.Ul) throw new F(M.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only call enablePersistence() before calling any other methods on a Firestore object.");
        var r = !1, i = !1;
        ...
        i = !!t.experimentalForceOwningTab && t.experimentalForceOwningTab, r && i)) throw new F(M.INVALID_ARGUMENT, "The 'experimentalForceOwningTab' setting cannot be used with 'synchronizeTabs'.");
        ...
        return e(this, void 0, void 0, (function() {
            var t, r = this;
            return n(this, (function(i) {
                if (void 0 !== this.Ul && !this.Ul.gl) throw new F(M.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
        ...
        return new P(this.Gc, this.Wl, this.jl.host, this.jl.ssl, this.jl.forceLongPolling);
    }, t.prototype.Hl = function(t, e, n) {
        var r = this.Jl();
        return this.Ul = new zi(this.Ql, this.ql), this.Ul.start(r, t, e, n);
    }, t.Bl = function(t) {
        if (e = t.options, "projectId", !Object.prototype.hasOwnProperty.call(e, "projectId")) throw new F(M.INVALID_ARGUMENT, '"projectId" not provided in firebase.initializeApp.');
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */        if (!n || "string" != typeof n) throw new F(M.INVALID_ARGUMENT, "projectId must be a string in FirebaseApp.options");
        return new L(n);
    }, Object.defineProperty(t.prototype, "app", {
        get: function() {
            if (!this.Ol) throw new F(M.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.Ol;
        },
        enumerable: !1,
        configurable: !0
        ...
        t.indexOf("/") >= 0) throw new F(M.INVALID_ARGUMENT, "Invalid collection ID '" + t + "' passed to function Firestore.collectionGroup(). Collection IDs must not contain '/'.");
    ...
    return t.prototype.set = function(t, e, n) {
        ...
        if (this.i_) throw new F(M.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }, t;
}(), Xi = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
    ...
    return t(n, e), n.Zl = function(t, e, r) {
        if (t.length % 2 != 0) throw new F(M.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + t.N() + " has " + t.length);
        ...
        !t) throw new F(M.INVALID_ARGUMENT, "Must provide a non-empty collection name to collection()");
        var e = z.$(t);
...
function eo(t, e, n, r, i, o, s) {
    var u;
    if (i.O()) {
        if ("array-contains" /* ARRAY_CONTAINS */ === o || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === o) throw new F(M.INVALID_ARGUMENT, "Invalid Query. You can't perform '" + o + "' queries on FieldPath.documentId().");
        if ("in" /* IN */ === o) {
            io(s, o);
    ...
    return function(t, e) {
        ...
        if (e.ln()) {
            var s = t.cn();
            if (null !== s && !s.isEqual(e.field)) throw new F(M.INVALID_ARGUMENT, "Invalid query. All where filters with an inequality (<, <=, >, or >=) must be on the same field. But you have inequality filters on '" + s.toString() + "' and '" + e.field.toString() + "'");
            var u = t.un();
            ...
            throw a === e.op ? new F(M.INVALID_ARGUMENT, "Invalid query. You cannot use more than one '" + e.op.toString() + "' filter.") : new F(M.INVALID_ARGUMENT, "Invalid query. You cannot use '" + e.op.toString() + "' filters with '" + a.toString() + "' filters.");
        }
    }(t, l), l;
}

function no(t, e, n) {
    if (null !== t.startAt) throw new F(M.INVALID_ARGUMENT, "Invalid query. You must not call startAt() or startAfter() before calling orderBy().");
    if (null !== t.endAt) throw new F(M.INVALID_ARGUMENT, "Invalid query. You must not call endAt() or endBefore() before calling orderBy().");
    var r = new Rn(e, n);
    return function(t, e) {
        if (null === t.un()) {
...
function ro(t, e, n) {
    if ("string" == typeof n) {
        if ("" === n) throw new F(M.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid document ID, but it was an empty string.");
        if (!cn(e) && -1 !== n.indexOf("/")) throw new F(M.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + n + "' contains a '/' character.");
        var r = e.path.child(z.$(n));
        if (!W.W(r)) throw new F(M.INVALID_ARGUMENT, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + r + "' is not because it has an odd number of segments (" + r.length + ").");
        return Wt(t, new W(r));
    }
    if (n instanceof Ni) return Wt(t, n.zc);
    throw new F(M.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + Zr(n) + ".");
}
 ...
 * array requirements.
 */ function io(t, e) {
    if (!Array.isArray(t) || 0 === t.length) throw new F(M.INVALID_ARGUMENT, "Invalid Query. A non-empty array is required for '" + e.toString() + "' filters.");
    if (t.length > 10) throw new F(M.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters support a maximum of 10 elements in the value array.");
    if (t.indexOf(null) >= 0) throw new F(M.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters cannot contain 'null' in the value array.");
    if (t.filter((function(t) {
        return Number.isNaN(t);
    })).length > 0) throw new F(M.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters cannot contain 'NaN' in the value array.");
}

function oo(t, e, n) {
    if (!n.isEqual(e)) throw new F(M.INVALID_ARGUMENT, "Invalid query. You have a where filter with an inequality (<, <=, >, or >=) on field '" + e.toString() + "' and so you must also use '" + e.toString() + "' as your first orderBy(), but your first orderBy() is on field '" + n.toString() + "' instead.");
}

function so(t) {
    if (t.an() && 0 === t.tn.length) throw new F(M.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
var uo = /** @class */ function() {
    ...
    return t.prototype.where = function(e, n, r) {
        ...
        void 0 === n || "asc" === n) r = "asc" /* ASCENDING */; else {
            if ("desc" !== n) throw new F(M.INVALID_ARGUMENT, "Function Query.orderBy() has unknown direction '" + n + "', expected 'asc' or 'desc'.");
            r = "desc" /* DESCENDING */;
        }
    ...
    /** Helper function to create a bound from a document or fields */ t.prototype.l_ = function(t, e, n, i) {
        if (ti(t, 1, e), e instanceof Zi) return jr(t, r([ e ], n), 1), function(t, e, n, r, i) {
            if (!r) throw new F(M.NOT_FOUND, "Can't use a DocumentSnapshot that doesn't exist for " + n + "().");
            ...
            for (var o = [], s = 0, u = hn(t); s < u.length; s++) {
                ...
                if (a.field.O()) o.push(Wt(e, r.key)); else {
                    ...
                    if (Ut(c)) throw new F(M.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + a.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                    if (null === c) {
                        var h = a.field.N();
                        throw new F(M.INVALID_ARGUMENT, "Invalid query. You are trying to start or end a query using a document for which the field '" + h + "' (used as the orderBy) does not exist.");
                    }
                    o.push(c);
                }
            }
        ...
        return function(t, e, n, r, i, o) {
            ...
            var s = t.tn;
            if (i.length > s.length) throw new F(M.INVALID_ARGUMENT, "Too many arguments provided to " + r + "(). The number of arguments must be less than or equal to the number of orderBy() clauses");
            for (var u = [], a = 0; a < i.length; a++) {
                var c = i[a];
                if (s[a].field.O()) {
                    if ("string" != typeof c) throw new F(M.INVALID_ARGUMENT, "Invalid query. Expected a string for document ID in " + r + "(), but got a " + typeof c);
                    if (!cn(t) && -1 !== c.indexOf("/")) throw new F(M.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + r + "() must be a plain document ID, but '" + c + "' contains a slash.");
                    var h = t.path.child(z.$(c));
                    if (!W.W(h)) throw new F(M.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + r + "() must result in a valid document path, but '" + h + "' is not because it contains an odd number of segments.");
                    var f = new W(h);
                    u.push(Wt(e, f));
                } else {
                    var l = Pi(n, r, c);
    ...
    return Object.defineProperty(t.prototype, "docs", {
        ...
        if (e && this.f_.Ut) throw new F(M.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
    ...
    function n(t, n, r) {
        var i = this;
        if ((i = e.call(this, an(t), n, r) || this).m_ = t, t.length % 2 != 1) throw new F(M.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t.N() + " has " + t.length);
        return i;
    }
    return t(n, e), Object.defineProperty(n.prototype, "id", {
        ...
        get: function() {
            ...
            return t._() ? null : new Xi(new W(t), this.firestore, 
            /* converter= */ null);
        },
        enumerable: !1,
        configurable: !0
        ...
        // 'undefined' and 'null'.
        0 === arguments.length && (t = k.t()), Kr("CollectionReference.doc", "non-empty string", 1, t);
        var e = z.$(t);
...
function ho(t, e) {
    ...
    if (ei(t, e, [ "merge", "mergeFields" ]), Yr(t, "boolean", "merge", e.merge), function(t, e, n, r, i) {
        void 0 !== r && function(t, e, n, r, i) {
            if (!(r instanceof Array)) throw new F(M.INVALID_ARGUMENT, "Function " + t + "() requires its " + e + " option to be an array, but it was: " + Zr(r));
            for (var o = 0; o < r.length; ++o) if (!i(r[o])) throw new F(M.INVALID_ARGUMENT, "Function " + t + "() requires all " + e + " elements to be " + n + ", but the value at index " + o + " was: " + Zr(r[o]));
        }(t, e, n, r, i);
    }(t, "mergeFields", "a string or a FieldPath", e.mergeFields, (function(t) {
        return "string" == typeof t || t instanceof hi;
    })), void 0 !== e.mergeFields && void 0 !== e.merge) throw new F(M.INVALID_ARGUMENT, "Invalid options passed to function " + t + '(): You cannot specify both "merge" and "mergeFields".');
    return e;
}
...
function po(t, e, n) {
    if (e instanceof Ni) {
        if (e.firestore !== n) throw new F(M.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
        return e;
    }
...
export { mo as __PRIVATE_registerFirestore };
